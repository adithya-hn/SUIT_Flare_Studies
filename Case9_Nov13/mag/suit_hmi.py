...
fltr='NB08'
hmi_files = sorted(glob(f"/media/adithya/Adi_disk4/SUIT_flare_work/case9_nov13/data/HMI/cut_outs/HMI_cutouts/*.fits")) 
suit_files=sorted(glob(f'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case9_Nov13/data/aligned_crop/*{fltr}.fits'))
...
times = []
intensities = []
print("Number of SUIT files found:", len(suit_files)) 
print("Number of HMI files Afound:", len(hmi_files)) 
print('----------------///\\\\----------------')
