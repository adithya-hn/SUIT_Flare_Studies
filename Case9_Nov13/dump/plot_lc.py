...
data2=(np.loadtxt(f'NB08_c10_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB08_Light_curve_data.dat'
data3=(np.loadtxt(f'NB04_c10_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB04_Light_curve_data.dat'
data4=(np.loadtxt(f'NB02_c10_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB02_Light_curve_data.dat'
data5=(np.loadtxt(f'NB05_c10_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB05_Light_curve_data.dat'
...
ax45.errorbar(helio_time_array,cdte1,yerr=cdte1_er, fmt='ro-',capsize=2,markersize=2,linewidth=0.5,label="Helios-CdTe1",alpha=0.5)
#ax3.plot(helio_time_array,cdte2, label="Helios")



ax45.spines.right.set_position(("axes", 1.1))
...
ax45.set_ylabel('HEL1OS counts',fontsize=13)
