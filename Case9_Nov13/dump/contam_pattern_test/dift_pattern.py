...
# Load the catalogue
catalogue_path = "/Analysis/Research_Projects/SUIT_work/SUIT_Database/SUIT_Data_Nov_catalogue_2024.csv"  # your monthly CSV file
...
start_time = pd.Timestamp("2024-11-12 22:23:00")
end_time   = pd.Timestamp("2024-11-12 23:59:50")
...
print(crpix_values)
crpix_values.to_csv("case9_crpix_values_2k.csv", index=False)
