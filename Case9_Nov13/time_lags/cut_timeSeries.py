...
for flt in ['NB03', 'NB04', 'NB08','flare_09']: #,
    # === USER INPUTS ===
    if flt == 'flare_09':
        ...
        df.columns = ['time', 'intensity_cdte1','intensity_cdte2']
    else:
        input_file = f"{flt}_c09_lc_data.csv"  # your input file
    ...
    start_time = "2024-11-12T23:10:00.000"  # ISOT start time
    end_time   = "2024-11-12T23:40:00.000"    # ISOT end time
