...
stix_spec.update_event_times(start=Time("2024-11-12T23:20:00"), end=Time("2024-11-12T23:21:00"))
...
plt.axvline(datetime.fromisoformat("2024-11-13T00:18:00"),ls='--',lw=2,color='b',label='Impuslive phase start time',alpha=0.7)
plt.gca().xaxis.set_major_formatter(mdates.DateFormatter('%H:%M'))
plt.gca().xaxis.set_major_locator(mdates.MinuteLocator(interval=5))
plt.xlim(plot_range[0],plot_range[1])
plt.title ('STIX Lightcurve (2024-Nov-13)')
plt.xlabel('Time (UT)')
