...
thermal_data=np.genfromtxt('9_Nov13_stix_timeResolved_th_fit.csv',delimiter=',', names=True, dtype=None, encoding='utf-8')
...
non_thermal=np.genfromtxt('9_Nov13_stix_timeResolved_th_fit_old.csv',delimiter=',', names=True, dtype=None, encoding='utf-8')
