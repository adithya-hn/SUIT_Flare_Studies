...
impulsive_phase_start_time = "2024-11-13T00:17:20"
goes_flare_start_time      = "2024-11-13T00:10:00"
TITLE    = "EM-T Evolution (SOL2024-11-13T00:23)"

thermal_range    = [datetime.fromisoformat("2024-11-13T00:15:00"),
                    datetime.fromisoformat("2024-11-13T00:17:20")]

nonthermal_range = [datetime.fromisoformat("2024-11-13T00:17:20"),
                    datetime.fromisoformat("2024-11-13T00:23:00")]

# hot_onset_time   =  datetime.fromisoformat("2024-11-01T14:18:00")

# hot_onset_time   =  [datetime.fromisoformat("2024-11-01T14:29:00"),
#                     datetime.fromisoformat("2024-11-01T14:30:40")]

fit_file= next(Path(".").glob("*.fits"))#glob.glob("*SDD2_L1_puc_tb_fit_results_with_bkg_T_EM_case2.fits")
lc1_file =next(Path(".").glob("*SDD2_L1_2.03_11.99keV_30sec.lc"))
# lc2_file= "AL1_SOLEXS_20241101_SDD2_L1_12.08_21.99keV_30sec.lc" #solexs 12-22 kev
lc3_file= 'LightCurve.csv' #helios above 22 kev

stix_t_em=pd.read_csv('c9_stix_hotonset_phase.csv')
...
temp=t_em[1].data['TEMPERATURE'][22:]
time_array=t_em[1].data['TIME'][22:]
em=t_em[1].data['EM'][22:]
t_er=t_em[1].data['TEMPERATURE_ERR'][22:]
em_er=t_em[1].data['EM_ERR'][22:]
t_dt=[]
for t in time_array:
...
plot_range=[datetime.fromisoformat(goes_flare_start_time)-timedelta(minutes=1),datetime.fromisoformat(impulsive_phase_start_time)+timedelta(minutes=1)]
ax.set_xlim(plot_range)
ax.xaxis.set_major_formatter(mdates.DateFormatter("%H:%M"))
ax.xaxis.set_major_locator(mdates.AutoDateLocator())
ax.set_ylabel(r"Count rate (s$^{-1}$)")
ax.set_title(f"Flare onset phase (SOL2024-11-13T00:23)")
...
plt.tight_layout()
plt.savefig("c9_solex_onset_lc.pdf", dpi=300)
plt.close()
