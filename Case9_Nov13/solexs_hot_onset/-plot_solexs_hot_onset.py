...
suit_int=pd.read_csv('c9_NB04_lc_data.csv')


Start_t = "2024-11-13T00:05:00"
End_t   = "2024-11-13T00:19:00"

thermal_range1    = [datetime.fromisoformat("2024-11-13T00:05:00"),
                    datetime.fromisoformat("2024-11-13T00:05:40")]

thermal_range    = [datetime.fromisoformat("2024-11-13T00:05:40"),
                    datetime.fromisoformat("2024-11-13T00:15:40")]

nonthermal_range = [datetime.fromisoformat("2024-11-13T00:15:40"),
                    datetime.fromisoformat("2024-11-13T00:23:00")]

hot_onset_time   =  datetime.fromisoformat("2024-11-13T00:13:30")
...
ax.axvline(datetime.fromisoformat("2024-11-13T00:10:00"),ls='--',lw=1,color='b',label='GOES flare start time',alpha=0.7)
ax.axvline(datetime.fromisoformat("2024-11-13T00:23:00"),ls='-',lw=1,color='b',label='Impuslive phase start time',alpha=0.7)
...
ax.set_title(f"Flare onset phase (SOL2024-11-13T00:23:00L)", fontsize=10)
...
ax21=ax2.twinx()
xe=10/86400
ax1.errorbar(pd.to_datetime(t_dt[22:]),temp[22:],xerr=timedelta(seconds=10),yerr=t_er[22:],ls='dotted',color='tab:red',label='Temperature')
ax11.errorbar(pd.to_datetime(t_dt[22:]),em[22:],xerr=timedelta(seconds=10),yerr=em_er[22:],ls='dotted',color='tab:blue',label='Emission measure')
...
plt.tight_layout()
plt.savefig("c9_stix_onset_lc.pdf", dpi=300)
plt.show()
