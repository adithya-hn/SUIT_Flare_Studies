...
flare_start = datetime.fromisoformat("2024-11-13T00:10:00")
flare_peak  = datetime.fromisoformat("2024-11-13T00:22:00")
background_start = datetime.fromisoformat("2024-11-13T00:06:30")
background_end   = datetime.fromisoformat("2024-11-13T00:09:30")
...
plt.axvline(flare_start, color='red', linestyle='--', label='Flare Start (00:10:00 UT)')
plt.axvline(flare_peak, color='green', linestyle='--', label='Flare Peak (00:22:00 UT)')
...
plt.axvspan(background_start, background_end, color='gray', alpha=0.3, label='Background Interval (00:06:30-00:09:30 UT)')
