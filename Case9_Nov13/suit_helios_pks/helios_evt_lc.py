...
command = [
    ...
    "--fits_file", "/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case9_Nov13/data/helios/2024/11/12/HLS_20241112_120000_43191sec_lev1_V111/events/evt.fits",
    "--mode", "CDTE_TOTAL",
    "--start_time", "2024-11-12T22:22:00.000",
    "--end_time", "2024-11-13T00:37:00.000",
    "--time_bin_size", "60",
    "--output", "LightCurve_1.csv"
]
...
sigma = 2.235*np.sqrt(bkg_safe*60)/60
