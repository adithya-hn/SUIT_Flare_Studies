...
for fltr in Filters:
    ...
    search_fold=f'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case9_Nov13/data/onset_raw/' #Custom Folder
    ref_baseMap=sunpy.map.Map('/media/adithya/Adi_disk4/SUIT_flare_work/case9_nov13/data/aia/cut_outs/1600_cutouts/aia.lev1_uv_24s.2024-11-13T000040Z.1600.image_lev1.fits')
    if fltr2=='HMI':
        base_fold=f'/media/adithya/Adi_disk4/SUIT_flare_work/case9_nov13/data/HMI/{fltr2}_cutouts/'
    
    else:
        base_fold=f'/media/adithya/Adi_disk4/SUIT_flare_work/case9_nov13/data/aia/cut_outs/{fltr2}_cutouts/'
    ...
    rect_template=SkyCoord(Tx=(-200,170 )* u.arcsec, Ty=(-350,-100 )* u.arcsec, frame=ref_baseMap.coordinate_frame)
