...
#-----------------Intial paths and params--------------------------
    ...
    aia_imgs='/media/adithya/Adi_disk4/SUIT_flare_work/case9_nov13/data/aia/cut_outs/171_cutouts/'
    hmi_imgs='/media/adithya/Adi_disk4/SUIT_flare_work/case9_nov13/data/HMI/HMI_cutouts/'
    ...
    np.savetxt('hmi_lc.csv',out,delimiter=',',header='time,reg1,reg2,reg3,reg4,reg5,reg6,reg7,reg8',fmt='%s',comments='')
