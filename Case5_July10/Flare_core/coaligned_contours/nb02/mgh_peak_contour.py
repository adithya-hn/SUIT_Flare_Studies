...
filter2_fold = '/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case5_July10/data/processed/Aligned_images/NB02/'
...
mgh_map=sunpy.map.Map('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case5_July10/data/processed/Aligned_images/NB02/SUT_T24_0956_000465_Lev1.0_2024-07-10T13.31.27.640_0983NB02.fits')
...
plt.savefig('Mg_II_blue_wing_map.jpg')
plt.show()

# Process all Filter 2 images and overlay Filter 1 contours
filter2_files = glob.glob(filter2_fold + '*3NB02.fits')
...
for filter2_file in filter2_files:
    ...
    #ax.set_colorbars()
    plt.title(f"mg II blue wing {filter2_map.date}", fontsize=16)
...
results_df.to_csv(('nb02_contours.csv'), index=False)