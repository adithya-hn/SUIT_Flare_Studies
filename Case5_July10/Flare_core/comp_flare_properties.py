...
for file in flare_light_curve_files:
    ...
    qs_peak_ratio=flare_peak_intensity / quiet_sun_intensity
    enhancement_qs = (flare_peak_intensity - quiet_sun_intensity) / quiet_sun_intensity
    ...
    plt.text(df['datetime'].min(), df['total_count'].max() * 0.7, props_text, fontsize=10,
