...
NB3_data=(np.loadtxt(f'NB04_M1.0_Light_curve_data.csv',delimiter=',',dtype='str')).transpose()
...
ax2.plot(nb3_time_array,list(map(int,nb3float_array)),'go-',markersize=2,linewidth=0.5,label='NB04')
