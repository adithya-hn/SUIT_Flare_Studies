...
cdte1_er=pow(np.array(Helios[3], dtype=np.float64),2)
cdte2_er=pow(np.array(Helios[4], dtype=np.float64),2)
...
#axs[0].errorbar(time_array1[nb3_c1:], (lc1_mean)[nb3_c1:],yerr=n_lc1_er[nb3_c1:],fmt='tab:blue', marker="o",capsize=2,markersize=2,linewidth=0.5); axs[0].legend(loc='lower right')
...
#axs[1].errorbar(time_array2[nb8_c1:nb8_c2], (lc2_mean)[nb8_c1:nb8_c2],yerr=n_lc2_er[nb8_c1:nb8_c2],fmt='black', marker="o",capsize=2,markersize=2,linewidth=0.5); axs[1].legend(loc='lower right')
