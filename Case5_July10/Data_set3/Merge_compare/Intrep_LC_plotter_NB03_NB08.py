...
#ax2.plot(nb3_time_array,list(map(int,nb3float_array)),color=colors_list[0],marker='o',markersize=2,linewidth=0.5,label='Mg II k Total count')
axs.plot(time_array,list(map(int,float_array)),color=colors_list[1],marker='^',markersize=2,linewidth=0.5,label='Ca II h Total count')

ax2.plot(time_array,(counts_2_interp/float_array),color=colors_list[2],marker='s',markersize=2,linewidth=0.5,label='Mg II k / Ca II h')
