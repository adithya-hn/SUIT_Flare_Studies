...
fol_nm='/Analysis/Projects_Data/Flare_Data/July10_Flare_Data2/Processed_/'
...
search_fold='/Analysis/Projects_Data/Flare_Data/July10_Flare_Data2/P_corr_data/' #'/scratch/suit_data/level1fits/2024/'+str(now.month).zfill(2)+'/'+str(now.day).zfill(2)+'/'+'normal_2k'+'/'
fdir =search_fold 
for fltr in Filters:
    if fltr=='NB03':
        Ref_idx=92
    ...
    ref_img=sunpy.map.Map('/Analysis/Projects_Data/Flare_Data/July10_Flare_Data2/P_corr_data/SUT_T24_0956_000465_Lev1.0_2024-07-10T13.31.19.741_0983NB03.fits')
