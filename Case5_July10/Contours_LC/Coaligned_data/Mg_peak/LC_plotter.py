...
data=(np.loadtxt(f'NB03_results.csv',delimiter=',',skiprows=1,dtype='str')).transpose() #'NB03_Light_curve_data.dat'
#print(data[0])
...
plt.plot(time_array,float_array/Contours_area,'ko-',markersize=2,linewidth=0.5,label='Total count of peak time contour')
'''
...
plt.title('Mg II k Light Curve (area normalized)')
plt.legend(loc='best')
