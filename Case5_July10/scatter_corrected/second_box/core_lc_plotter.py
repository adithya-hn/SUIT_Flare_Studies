...
data1=(np.loadtxt(f'NB03_M1.box2_lc.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
...
data2=(np.loadtxt(f'NB08_M1.box2_lc.csv',delimiter=',',dtype='str')).transpose() #'NB08_Light_curve_data.dat'
