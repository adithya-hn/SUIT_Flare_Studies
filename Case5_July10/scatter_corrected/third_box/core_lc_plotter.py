...
data1=(np.loadtxt(f'nb03_m1_box3_lc.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
...
data2=(np.loadtxt(f'nb08_m1_box3_lc.csv',delimiter=',',dtype='str')).transpose() #'NB08_Light_curve_data.dat'
...
img_nm='nb8_box2_lc_sc.png'
plt.ylabel('Total counts',fontsize=13)
plt.xlabel('Time',fontsize=13)
plt.axvline(m_cls,color='orange',linestyle='--',label='GOES Flare start time')
plt.axvline(m_cls_p,color='orange',linestyle='-',label='GOES Flare peak time')
plt.title('Ca II h light curve')
plt.figlegend(bbox_to_anchor=(0.001, 0.005, 0.37, 0.5))
