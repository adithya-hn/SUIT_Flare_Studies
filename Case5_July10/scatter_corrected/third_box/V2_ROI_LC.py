...
for fltr in Filters:
    ...
    for i in range(len(Sequence)):
        ...
        suit_map.plot(axes=ax, vmin=0, vmax=I_mx) # exposure normalization not accounted
        coords = SkyCoord(Tx=(-225, -25) * u.arcsec, Ty=(-300, -100) * u.arcsec, frame=suit_map.coordinate_frame)
