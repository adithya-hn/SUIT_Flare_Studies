...
data=(np.loadtxt(f'NB08_M1.box2_lc.csv',delimiter=',',skiprows=1,dtype='str')).transpose() #'NB08_Light_curve_data.dat'
date_array=data[0]

NB3_data=(np.loadtxt(f'NB03_M1.box2_lc.csv',delimiter=',',skiprows=1,dtype='str')).transpose()
