...
data=(np.loadtxt(f'{param}_M1.box2_lc.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
#print(data[0])
...
Flt=param
axis_title='Median count'
img_nm=Flt+'Sc_light_curve_algn.png'
...
plt.title(Flt+' Scatter corrected Light Curve(aligned)')
