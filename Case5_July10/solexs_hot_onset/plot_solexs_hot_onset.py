...
fit_file='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case5_July10/solexs_hot_onset/AL1_SOLEXS_20240710_SDD2_L1_puc_tb_fit_results_with_bkg_T_EM_case2.fits'
lc1_file ="/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case5_July10/solexs_hot_onset/AL1_SOLEXS_20240710_SDD2_L1_2.03_11.99keV_30sec.lc" #solexs 2-12 kev
...
suit_int=pd.read_csv('c5_NB04_lc_data.csv')

Start_t = "2024-07-10T15:20:00"
End_t   = "2024-07-10T15:37:00"

# thermal_range    = [datetime.fromisoformat("2024-07-10T05:39:00"),
#                     datetime.fromisoformat("2024-07-10T05:50:00")]

# nonthermal_range = [datetime.fromisoformat("2024-10-09T01:30:40"),
#                     datetime.fromisoformat("2024-10-09T01:33:00")]

hot_onset_time   =  datetime.fromisoformat("2024-07-10T15:29:00")
...
ax.axvline(datetime.fromisoformat("2024-07-10T15:25:00"),ls='--',lw=1,color='b',label='GOES flare start time',alpha=0.7)
ax.axvline(datetime.fromisoformat("2024-07-10T15:35:30"),ls='-',lw=1,color='b',label='Impulsive phase start time',alpha=0.7)
...
ax.set_title(f"Flare onset phase (SOL2024-07-10T15:37:00L)", fontsize=10)
...
ax21=ax2.twinx()
xe=10/86400
ax1.errorbar(pd.to_datetime(t_dt[2:]),temp[2:],xerr=timedelta(seconds=10),yerr=t_er[2:],ls='dotted',color='tab:red',label='Temperature')
ax11.errorbar(pd.to_datetime(t_dt[2:]),em[2:],xerr=timedelta(seconds=10),yerr=em_er[2:],ls='dotted',color='tab:blue',label='Emission measure')
...
plt.tight_layout()
plt.savefig("c5_solexs_onset_lc.pdf", dpi=300)
plt.show()
