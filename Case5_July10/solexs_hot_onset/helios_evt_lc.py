...
command = [
    ...
    "--fits_file", "/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case5_July10/suit_helios_pks/evt.fits",
    "--mode", "CDTE_TOTAL",
    "--start_time", "2024-07-10T15:10:00.000",
    "--end_time", "2024-07-10T15:52:00.000",
    "--time_bin_size", "30",
