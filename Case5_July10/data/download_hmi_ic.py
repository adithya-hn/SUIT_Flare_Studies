...
star_time=Time('2024-07-10T13:29:00', scale='utc', format='isot')
end_time= Time('2024-07-10T13:29:30', scale='utc', format='isot')
out_dir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case5_July10/data/aia'
