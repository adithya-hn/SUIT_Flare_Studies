...
data=(np.loadtxt(f'NB08_cont_counts.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
date_array=data[0]

NB3_data=(np.loadtxt(f'NB03_cont_counts.csv',delimiter=',',dtype='str')).transpose()
