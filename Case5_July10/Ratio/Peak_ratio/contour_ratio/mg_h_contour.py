...
filter1_fold = '/Analysis/Projects_Data/Flare_Data/July10_Flare_Data2/Processed_/Aligned_images/NB04/'

specific_file_filter1='/Analysis/Projects_Data/Flare_Data/July10_Flare_Data2/Processed_/Aligned_images/NB03/SUT_T24_0956_000465_Lev1.0_2024-07-10T15.35.28.135_0983NB03.fits'
...
filter2_files = glob.glob(filter1_fold + '*3NB08.fits')
...
for filter2_file in filter2_files:
    ...
    vr=ax.imshow(filter2_data,origin='lower' ,cmap='gray', vmin=1000, vmax=14000)  # Adjust vmin/vmax as needed
