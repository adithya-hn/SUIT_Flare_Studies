...
axs.errorbar(time_array,list(map(int,float_array)),yerr=y_er,fmt='ko',capsize=2,markersize=2,linewidth=0.5,label='Ca-II h Total count')
axs.set_ylabel('Total count (Ca II h)')
...
plt.figlegend(bbox_to_anchor=(0.5, 0.35, 0.35, 0.5))
