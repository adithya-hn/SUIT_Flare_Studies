...
#data=(np.loadtxt(f'cabox_{param}_M2.1_Light_curve_data.csv',delimiter=',',dtype='str')).transpose()
data=(np.loadtxt(f'GONG_X1.4_Light_curve_data.csv',delimiter=',',dtype='str')).transpose()
date_array=data[0]
...
axs.minorticks_on()
axs.plot(time_array,float_array,'ko',markersize=2,linewidth=0.5,label='H-alpha')

x_cls=datetime.fromisoformat('2024-07-10T15:30:00.000')
x_cls_p=datetime.fromisoformat('2024-07-10T15:37:00.000')

#axs2[0,0].plot(AR_I,AR_M,'ko',markersize=1.5)
Flt=param
axis_title='Total count'
img_nm='cabox_Halpha_light_curve.png'
