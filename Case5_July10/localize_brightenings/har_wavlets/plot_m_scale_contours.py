...
data  = fits.getdata('NB04_aligned_cube.fits')
data1 = fits.getdata('NB04_t1_cube.fits')
data2 = fits.getdata('NB04_t2_cube.fits')
data3 = fits.getdata('NB04_t3_cube.fits')
data4 = fits.getdata('NB04_t4_cube.fits')
data5 = fits.getdata('NB04_t5_cube.fits')
data6 = fits.getdata('NB04_t6_cube.fits')
