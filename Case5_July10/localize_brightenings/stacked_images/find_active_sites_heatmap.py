...
suit_aligned_files= '/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case5_July10/data/aligned_crop_/'
...
#aia_fl='/media/adithya/Adi_disk4/SUIT_flare_work/case5_jul10/data/aia/cut_outs/171_cutouts/aia.lev1_euv_12s.2024-07-10T133758Z.171.image_lev1.fits'
...
im2=ax.imshow(heat_masked, origin='lower', cmap='rainbow', alpha=0.6,label='stacked contours')
fig.colorbar(im1,label='SUIT DN/s')
fig.colorbar(im2,label='No. of stacked contours')
#plt.title(f'{'Mg II h'}')
