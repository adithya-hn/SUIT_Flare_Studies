...
peak_time=datetime.datetime(2024, 7,10 ,15,37, 0)
...
base_image='SDO' #suit
if base_image=='SDO':
    aia_fl='/media/adithya/Adi_disk4/SUIT_flare_work/case5_jul10/data/HMI/HMI_cutouts/1/hmi.m_45s.20240710_133730_TAI.2.magnetogram.fits'#'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case4_July10/data/aia/aia.lev1_euv_12s.2024-07-10T040010Z.171.image_lev1.fits'
    hmi_imgs   = '/media/adithya/Adi_disk4/SUIT_flare_work/case5_jul10/data/HMI/HMI_cutouts/1/'
fltr='NB04'
thresh_sig=5
...
#pil_msk.plot(axes=ax,cmap='binary')
...
ax.set_xlim(10,450)
ax.set_ylim(80,500)
plt.savefig(f'HMI_{fltr}_stacked_contours.pdf',dpi=300)
plt.show()
