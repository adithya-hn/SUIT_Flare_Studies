...
for fltr in Filters:
    ...
    ref_img=sunpy.map.Map('/Analysis/Projects_Data/Flare_Data/July10_Flare_Data2/july10_11ut_to_18ut/SUT_T24_0956_000465_Lev1.0_2024-07-10T11.11.02.770_0973NB03.fits')
