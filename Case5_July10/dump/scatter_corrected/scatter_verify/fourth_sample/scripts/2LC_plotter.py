...
data=(np.loadtxt(f'{param}_c5_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
...
plt.title(Flt+' Scatter corrected QS Light Curve (with HPG coords)')
