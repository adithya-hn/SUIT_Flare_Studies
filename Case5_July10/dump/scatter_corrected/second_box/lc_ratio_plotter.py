...
data=(np.loadtxt(f'nb08_m1_box2_lc.csv',delimiter=',',dtype='str')).transpose() #'NB08_Light_curve_data.dat'
NB3_data=(np.loadtxt(f'nb03_m1_box2_lc.csv',delimiter=',',dtype='str')).transpose()
