...
flare_light_curve_files = ['NB03_M1.0_Light_curve_data.csv', 'NB04_M1.0_Light_curve_data.csv', 'NB08_M1.0_Light_curve_data.csv']
...
for file in flare_light_curve_files:
    ...
    if file=='NB08_M1.0_Light_curve_data.csv':
