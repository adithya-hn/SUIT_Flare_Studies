...
def detect_transient_times(ts, wavelet="haar", levels_keep=[1,2], sigma=1.0):
    """
...
for y in range(ny):
    for x in range(nx): 
        ...
        flag = detect_transient_times(ts,wavelet=wavelet,levels_keep=levels_keep)
