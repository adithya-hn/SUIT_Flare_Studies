...
for flt in ['NB03', 'NB04', 'NB08','flare_1']: #,
    # === USER INPUTS ===
    if flt == 'flare_1':
    ...
    start_time = "2024-06-01T07:45:00.000"  # ISOT start time
    end_time = "2024-06-01T08:20:00.000"    # ISOT end time
    ...
    segment['error'] = np.sqrt((segment[intensity_col]).astype(int))

    # Reorder columns
    segment = segment[['time', intensity_col, 'error']]
