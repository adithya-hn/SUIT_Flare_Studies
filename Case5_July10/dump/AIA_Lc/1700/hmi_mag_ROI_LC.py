...
search_fold='/Analysis/Projects_Data/Flare_Data/July10_Flare_Data2/AIA_Data/1700/'
...
for i in tqdm(range (len(Sequence))):
    ...
    diffrot_point1 = SkyCoord(RotatedSunFrame(base=point1, duration=60*(i+1)*u.second)) #15min 1600
    ...
    diffrot_point2 = SkyCoord(RotatedSunFrame(base=point2, duration=60*(i+1)*u.second))
