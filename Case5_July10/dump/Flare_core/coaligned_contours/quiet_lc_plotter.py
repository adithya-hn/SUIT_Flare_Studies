...
#-------------------------------
data1=(np.loadtxt(f'nb03_contours.csv',skiprows=1,delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
data2=(np.loadtxt(f'nb08_contours.csv',skiprows=1,delimiter=',',dtype='str')).transpose() #'NB08_Light_curve_data.dat'
...
axs.errorbar(time_array1,float_array_er1,yerr=np.sqrt(float_array_er1/20736),fmt='ko-',capsize=2,markersize=2,linewidth=0.5, label='Mg II k light curve')
