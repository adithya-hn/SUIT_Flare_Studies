...
data=(np.loadtxt(f'{Flt}_contours.csv',delimiter=',',skiprows=1,dtype='str')).transpose() 
...
'''
axs.errorbar(time_array,float_array_er,yerr=qs_err,fmt='bo-',markersize=2,linewidth=0.5,label='AR total count \n of peak time contour')
...
ax4.errorbar(time_array,float_array_er,yerr=qs_err,fmt=clr_fmt,markersize=2,linewidth=0.5,label='Mean QS')
