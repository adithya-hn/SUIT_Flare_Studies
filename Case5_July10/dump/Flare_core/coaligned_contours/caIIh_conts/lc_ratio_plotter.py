...
NB3_data=(np.loadtxt(f'nb04_contours.csv',delimiter=',',skiprows=1,dtype='str')).transpose()
...
img_nm='c5_ratio_light_curve_nb08_nb04.png'
...
plt.title('Ca II h/Mg II h ratio Light Curves')
...
img_nm_='c5_enhnace_light_curve_nb08_nb04.png'
