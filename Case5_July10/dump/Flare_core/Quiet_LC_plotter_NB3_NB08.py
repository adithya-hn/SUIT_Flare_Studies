...
data=(np.loadtxt(f'NB08_M1.0_flare_core_Light_curve_data.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
date_array=data[0]
...
axs.plot(time_array,float_array_er,'ko-',markersize=2,linewidth=0.5,label='Ca II h')
ax2.plot(nb3_time_array,nb3float_array_er,'bo-',markersize=2,linewidth=0.5,label='Mg II k')
...
img_nm='NB08_NB03_Quiet_light_curve.png'
