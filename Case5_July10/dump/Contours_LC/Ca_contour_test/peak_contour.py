...
specific_timestamp = "2024-07-10T15.34.38.918"  # Replace with your desired timestamp

# Paths to Filter 1 and Filter 2 data
filter1_fold = '/Analysis/Projects_Data/Flare_Data/July10_Flare_Data2/Processed/Aligned_images/NB08/'
filter2_fold = '/Analysis/Projects_Data/Flare_Data/July10_Flare_Data2/Processed/Aligned_images/NB08/'

# Find the specific file for Filter 1
filter1_files = glob.glob(filter1_fold + '*3NB08.fits')
...
Thresh_val=4000 #np.mean(qs_data)+4*np.std(qs_data)
