...
fdir='/Analysis/Projects_Data/Flare_Data/July10_Flare_Data2/Processed_3/Aligned_images/'
fdir2='/Analysis/Projects_Data/Flare_Data/July10_Flare_Data2/Processed/Aligned_images/'
...
for fltr in Filters:
    ...
    files1 = sorted(glob.glob(fdir+fltr + '/*3'+fltr+'.fits'))
    files2 = sorted(glob.glob(fdir2+fltr + '/*3'+fltr+'.fits'))
