...
ax.scatter(nb3_date_array,nb3_count, label='Mg II k SUIT', color='blue', marker='o', s=1,linewidth=0.5)
...
ax2.scatter(date_array,iris_count, label='Mg II k IRIS', color='red', marker='o', s=1,linewidth=0.5)

ax.set_ylabel('IRIS Counts')
ax.set_xlabel('Date')
plt.title('IRIS data')

plt.figlegend(bbox_to_anchor=(0.001, 0.35, 0.65, 0.5))
time_formatter = mdates.DateFormatter('%H:%M')  # Format as HH:MM
plt.gca().xaxis.set_major_formatter(time_formatter)
plt.savefig('iris_nb3_flare_lc.png', dpi=300)
plt.show()
plt.close()