...
command = [
    ...
    "--mode", "CDTE_TOTAL",
    "--start_time", "2024-11-13T15:08:00.000",
    "--end_time", "2024-11-13T17:23:00.000",
    "--time_bin_size", "60",
...
sigma = 1.253*np.sqrt(bkg_safe*60)/60  # 1.253 is the correction factor for Poisson noise in a bin of width 60 seconds
