...
star_time=Time('2024-06-02T06:29:00', scale='utc', format='isot')
end_time=Time('2024-06-02T06:29:30', scale='utc', format='isot')
out_dir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case3_June02/data/aia'
