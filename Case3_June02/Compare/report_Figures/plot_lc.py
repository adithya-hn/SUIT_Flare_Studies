...
ax41.errorbar(time_array3,list(map(int,float_array3)),yerr=float_array_er3_,fmt='co',capsize=2,markersize=2,linewidth=0.5, label='Mg II h light curve')
...
ax43.set_ylabel('HEL1OS',fontsize=13)
