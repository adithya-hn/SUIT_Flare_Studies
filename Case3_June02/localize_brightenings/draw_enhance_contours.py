...
#-----------------Intial paths and params--------------------------
    ...
    suit_aligned_files= '/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case1_Jun01/data/aligned_crop/'
    aia_imgs='/media/adithya/Adi_disk4/SUIT_flare_work/case1_Jun01/data/aia/cut_outs/171_cutouts/'
