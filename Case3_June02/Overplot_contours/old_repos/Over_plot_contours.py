...
for fltr in Filters:
    ...
    search_fold=f'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case3_June02/data/raw/' #Custom Folder
    #search_fold2=f'/Analysis/Projects_Data/Flare_Data/July10_Flare_Data2/P_corr_data/'
    if fltr2=='HMI':
        base_fold=f'/media/adithya/Adi_disk4/SUIT_flare_work/Flare_Data/June02_Flare_Data2/{fltr2}/{fltr2}_cutouts/'
    elif fltr2=='GONG':
        base_fold=f'/Analysis/Projects_Data/Flare_Data/June01_Flare_Data/{fltr2}/{fltr2}_cutouts/'
    else:
        base_fold=f'/media/adithya/Adi_disk4/SUIT_flare_work/June01_Flare/AIA_Data/AIA/{fltr2}/{fltr2}_cutouts/'
