...
export_request = client.export(query_time_range) # No proper headers will be there for HMI images but download is faster
...
'''
# Save the result to a CSV file - needed for HMI images
