...
fol_nm='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case3_June02/GONG'
fol_nm=fol_nm+'/'+'Imgs'
pathlib.Path(fol_nm).mkdir(parents=True, exist_ok=True)

search_fold='/Analysis/Projects_Data/Flare_Data/June02_Flare_Data2/GONG/GONG_cutouts/'
tx1=-325
tx2=-200
ty1=-250
ty2=-170
