...
fol_nm='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case3_June02/GONG'#str(now.day)+'_'+str(now.month).zfill(2)+'_'+str(now.year).zfill(2)
...
search_fold='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case3_June02/GONG/Imgs/H_alpha/Fits/' #'/scratch/suit_data/level1fits/2024/'+str(now.month).zfill(2)+'/'+str(now.day).zfill(2)+'/'+'normal_2k'+'/'
fdir =search_fold 


files = sorted(glob.glob(fdir +'*Uh.fits'))
