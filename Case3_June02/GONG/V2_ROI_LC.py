...
fdir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case3_June02/GONG/Aligned_images/'
...
for i in range(len(Sequence)):
    ...
    coords = SkyCoord(Tx=(-325, -200) * u.arcsec, Ty=(-250, -170) * u.arcsec, frame=suit_map.coordinate_frame)
...
np.savetxt(f'{fltr}_M2.1_Light_curve_data.csv',np.c_[date_array,fltr_count],delimiter=',',fmt='%s')
