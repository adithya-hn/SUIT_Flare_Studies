...
if OPTS.noplot:
    ...
    plt.text((OPTS.lgl[0]-(0.25*OPTS.lgl[0])), 0.8,'Lag of {} seconds \nWith DCF val: {} $\pm$ {}'.format(round(T[idx],2),mx_dcf,decf_er), color='red', bbox=dict(facecolor='none',pad=10, edgecolor='red'))
