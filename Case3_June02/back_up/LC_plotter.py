...
y_er=np.sqrt(float_array/78336)
axs.errorbar(time_array,list(map(int,float_array)),yerr=y_er,fmt='k', marker="o",capsize=2,markersize=2,linewidth=0.5,label='Ca II h')
'''
