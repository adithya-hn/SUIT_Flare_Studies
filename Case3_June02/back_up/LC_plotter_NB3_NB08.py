...
y_er=np.sqrt(float_array/78336)#np.std(float_array_er)
nb3_y_er=np.sqrt(nb3float_array/78336)#np.std(float_array_er)

axs.errorbar(time_array,list(map(int,float_array)),yerr=y_er,fmt='k',capsize=2,markersize=2,linewidth=0.5,label='Ca II h')
ax2.errorbar(nb3_time_array,list(map(int,nb3float_array)),yerr=nb3_y_er,fmt='tab:blue',capsize=2,markersize=2,linewidth=0.5,label='Mg II k')
