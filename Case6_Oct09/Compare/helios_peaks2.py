...
data=np.loadtxt('helios_CdTe_c6.csv',delimiter=',',skiprows=1,dtype='str')
...
z = (counts - bkg_safe) / (sigma*1.253/np.sqrt(window))    # "Gaussian-equivalent" significance per bin
