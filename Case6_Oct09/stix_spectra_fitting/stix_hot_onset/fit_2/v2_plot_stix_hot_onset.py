...
# Modifications(29-6-2026):
- Results from new fitting scripts where background is choosen much closer to the flare onset time.
...
End_t   = "2024-10-09T01:32:00"


thermal_range    = [datetime.fromisoformat("2024-10-09T01:25:40"),
                    datetime.fromisoformat("2024-10-09T01:30:00")]

nonthermal_range = [datetime.fromisoformat("2024-10-09T01:30:00"),
                    datetime.fromisoformat("2024-10-09T01:33:00")]

hot_onset_time   =  datetime.fromisoformat("2024-10-09T01:25:40")
...
t_em=pd.read_csv('c6_stix_hotonset_phase.csv')
...
ax1.annotate("NTH fit", xy=(nonthermal_range[0], ax1.get_ylim()[1]),
            xytext=(5, -12), textcoords="offset points",
...
ax11.legend(ln1 + ln2, lbl1 + lbl2, loc='lower left',frameon=True, framealpha=0.8, facecolor='white', edgecolor='none')
