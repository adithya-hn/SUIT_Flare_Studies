...
#-------------in put path------------------------
Filters=['NB06','NB02','NB05','NB07']
for flt in Filters:
    print(f'cropping {flt}')
    files = sorted(glob.glob(f"/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case6_Oct09/data/1600_aligned/*{flt}.fits"))
