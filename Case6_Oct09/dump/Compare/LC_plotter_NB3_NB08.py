...
data=(np.loadtxt(f'NB08_X1.8_Light_curve_data.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
date_array=data[0]

NB3_data=(np.loadtxt(f'NB03_X1.8_Light_curve_data.csv',delimiter=',',dtype='str')).transpose()
...
x_cls=datetime.fromisoformat('2024-10-09T01:25:00.000')
x_cls_p=datetime.fromisoformat('2024-10-09T01:56:00.000')
