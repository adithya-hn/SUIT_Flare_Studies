...
lc1_file ="AL1_SOLEXS_20241009_SDD2_L1_2.03_11.99keV_30sec.lc" #solexs 2-12 kev
lc2_file= "AL1_SOLEXS_20241009_SDD2_L1_12.08_21.99keV_30sec.lc" #solexs 12-22 kev
...
flare_start = datetime.fromisoformat("2024-10-09T01:25:00")
flare_peak  = datetime.fromisoformat("2024-10-09T01:56:00")
background_start = datetime.fromisoformat("2024-10-09T01:10:30")
background_end   = datetime.fromisoformat("2024-10-09T01:13:30")
...
plt.axvline(flare_start, color='red', linestyle='--', label='Flare Start (01:25:00 UT)')
plt.axvline(flare_peak, color='green', linestyle='--', label='Flare Peak (01:56:00 UT)')
...
plt.axvspan(background_start, background_end, color='gray', alpha=0.3, label='Background Interval (01:10:30-01:13:30 UT)')
