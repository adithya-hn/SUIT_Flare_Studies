...
filter2_fold = '/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case6_Oct09/data/processed/aligned_fits/NB04/'

Tx1_qs1,Ty1_qs1=-90,20
Tx2_qs1,Ty2_qs1=-10,-70

# Load the Filter 1 image and compute its contours
ref_mg_map = sunpy.map.Map('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case6_Oct09/data/processed/aligned_fits/NB03/SUT_T24_1472_000592_Lev1.0_2024-10-09T01.49.26.972_0983NB03.fits')
mgh_map=sunpy.map.Map('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case6_Oct09/data/processed/aligned_fits/NB04/SUT_T24_1472_000592_Lev1.0_2024-10-09T01.49.20.214_0983NB04.fits')
