...
data=(np.loadtxt(f'NB08_X1.8_core_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB08_Light_curve_data.dat'
NB3_data=(np.loadtxt(f'NB03_X1.8_core_lc_data.csv',delimiter=',',dtype='str')).transpose()
