...
for fltr in Filters:
    ...
    for i in range(len(Sequence)):
        ...
        coords = SkyCoord(Tx=(-100, 150) * u.arcsec, Ty=(230, 130) * u.arcsec, frame=suit_map.coordinate_frame)
        ...
        er_coords = SkyCoord(Tx=(-90, 10) * u.arcsec, Ty=(20, -80) * u.arcsec, frame=suit_map.coordinate_frame)
    ...
    np.savetxt(f'{fltr}_X1.8_core_lc_data.csv',np.c_[date_array,fltr_count,fltr_count_err,bx_area],delimiter=',',fmt='%s')
