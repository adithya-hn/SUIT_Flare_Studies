...
#-------------
ca_map = sunpy.map.Map('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case6_Oct09/data/processed/aligned_fits/NB08/SUT_T24_1472_000592_Lev1.0_2024-10-09T01.48.24.118_0983NB08.fits') #not sure about this
...
im=plt.imshow(ca_map_data, origin='lower', cmap='gray', vmin=0, vmax=6000)
ca_map.draw_quadrangle(qs_coords1, axes=ax, edgecolor="blue", linestyle="-", linewidth=2, label='Ca-II h Flare contour')
hpc_coord=[]
