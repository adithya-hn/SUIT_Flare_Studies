...
qs_intrep_counts=interp_func_qs(t1_stamps) #second fltr
...
axs.plot(time_array,((float_array/float_array_er)/(counts_2_interp/qs_intrep_counts)),color=colors_list[2],marker='s',markersize=2,linewidth=0.5,label='AR ratio ')
img_nm=f'norm{img_suffix}_ratio_lc_{flt1}_{flt2}.png'
...
ax3.plot(time_array,((float_array/float_array_er)/(counts_2_interp/qs_intrep_counts)),color=colors_list[2],marker='s',markersize=2,linewidth=0.5,label='AR ratio ')
ax3.set_ylabel('Ratio')
ax3.set_xlabel('Time')
axis_title='Total count'
img_nm3=f'norm_{img_suffix}_AR_ratio_lc_{flt1}_{flt2}.png'
