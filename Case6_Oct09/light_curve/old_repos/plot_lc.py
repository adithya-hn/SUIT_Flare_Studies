...
axs1.errorbar(time_array5[start:],nb3_counts[start:],yerr=nb3_counts_er[start:],fmt='y', marker="o",capsize=2,markersize=2,linewidth=0.5,label=r'Difference image intensity above 4 $\sigma$')
