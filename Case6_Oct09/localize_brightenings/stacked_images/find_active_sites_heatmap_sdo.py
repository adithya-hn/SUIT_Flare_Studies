...
peak_time=datetime.datetime(2024, 10,9 ,1,56, 0)
start_time=datetime.datetime(2024, 10,9 ,1,25, 0)
...
base_image='SDO' #suit
if base_image=='SDO':
    aia_fl='/media/adithya/Adi_disk4/SUIT_flare_work/case6_oct09/data/HMI/HMI_cutouts/1/hmi.m_45s.20241008_235615_TAI.2.magnetogram.fits'#'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case4_July10/data/aia/aia.lev1_euv_12s.2024-07-10T040010Z.171.image_lev1.fits'
...
if base_image=='SDO':
    ...
    im2=ax.imshow(aia_map.data/1e3,cmap='grey',alpha=1,vmin=-2,vmax=2,transform=ax.get_transform(aia_map.wcs))
...
ax.set_xlim(10,450)
ax.set_ylim(80,500)
plt.savefig(f'HMI_{fltr}_stacked_contours.png',dpi=300)
# plt.savefig(f'c5_{fltr}_stacked_contours.pdf',dpi=300)
plt.show()
