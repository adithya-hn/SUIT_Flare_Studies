...
for fltr in Filters:
    ...
    search_fold=f'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case6_Oct09/data/onset_raw/' #Custom Folder
    ref_baseMap=sunpy.map.Map('/media/adithya/Adi_disk4/SUIT_flare_work/case6_oct09/data/aia/cut_outs/1600_cutouts/aia.lev1_uv_24s.2024-10-09T003016Z.1600.image_lev1.fits')
    if fltr2=='HMI':
        base_fold=f'/media/adithya/Adi_disk4/SUIT_flare_work/case6_oct09/data/HMI/{fltr2}_cutouts/'
    
    else:
        base_fold=f'/media/adithya/Adi_disk4/SUIT_flare_work/case6_oct09/data/aia/cut_outs/{fltr2}_cutouts/'
    ...
    rect_template=SkyCoord(Tx=(9,270 )* u.arcsec, Ty=(-42,-330 )* u.arcsec, frame=ref_baseMap.coordinate_frame)
    ...
    for i in tqdm (range(len(files))):
        ...
        th_lvs2=[1500,3100,3500]
        th_lvs=[3500,11000,15000]
        #th_lvs=[3000,8000]
