...
path_dir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case6_Oct09/Overplot_contours/nb04/'
# Replace 'my_image.png' with the actual path to your image file

imgs=sorted(glob.glob(path_dir+'*.jpg'))

data1=(np.loadtxt(f'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case6_Oct09/Overplot_contours/caIIh_contours.csv',delimiter=',',skiprows=1,dtype='str')).transpose() 
data2=(np.loadtxt(f'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case6_Oct09/Overplot_contours/mgIIh_contours.csv',delimiter=',',skiprows=1,dtype='str')).transpose() 
...
plt.tight_layout()
ani.save("171_lc_suit_aia_image.gif", writer='ffmpeg',dpi=300, fps=5)
plt.show()