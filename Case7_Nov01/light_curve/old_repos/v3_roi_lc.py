...
for fltr in Filters:
    ...
    for i, suit_map in enumerate(Sequence):
        ...
        if suit_map.meta.get("CROTA2"):
            rotation_angle=suit_map.meta.get("CROTA2")
            print('CROTA2 not found going for P angle')
        else:
        ...
        center_coord4 = SkyCoord(qs1Tx * u.arcsec, qs1Ty * u.arcsec, frame=suit_map.coordinate_frame)
    ...
    # Save light curve
    np.savetxt(f'csv_files/{fltr}_c7_lc_data.csv',
