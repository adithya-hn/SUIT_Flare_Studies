...
data2=(np.loadtxt(f'csv_files/NB05_c{C_n}_lc_data.csv',delimiter=',',skiprows=1,dtype='str')).transpose() 
...
axs[1].errorbar(time_array2[:nb8_c1], (lc2_mean)[:nb8_c1],yerr=lc2_mean_er[:nb8_c1],fmt='black', marker="o",capsize=2,markersize=2,linewidth=0.5, label="SUIT NB05"); axs[1].legend(loc='lower right')
axs[1].errorbar(time_array2[nb8_c1:], (lc2_mean)[nb8_c1:],yerr=lc2_mean_er[nb8_c1:],fmt='black', marker="o",capsize=2,markersize=2,linewidth=0.5); axs[1].legend(loc='lower right')
#axs[1].errorbar(time_array2[nb8_c2:], (lc2_mean)[nb8_c2:],yerr=n_lc2_er[nb8_c2:],fmt='black', marker="o",capsize=2,markersize=2,linewidth=0.5); axs[1].legend(loc='lower right')
