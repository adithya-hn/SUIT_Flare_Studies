...
axs[1].errorbar(helio_time_array[hel1:], cdte[hel1:],yerr=cdte_er[hel1:],fmt='tab:red', marker="o",capsize=2,markersize=2,linewidth=0.5, label="HEL1OS (CdTe1+CdTe2)"); axs[1].legend(loc='upper center')
axs[2].errorbar(time_array4[sole1:],sl_temp[sole1:],yerr=sl_temp_er[sole1:],fmt='g-', marker="o",capsize=2,markersize=2,linewidth=0.5, label='SoLEXS Temperature'); axs[2].legend(loc='upper center')
