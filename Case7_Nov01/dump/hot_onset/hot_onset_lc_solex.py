...
data1=(np.loadtxt(f'c7_NB04_lc_data.csv',delimiter=',',skiprows=1,dtype='str')).transpose() #'NB03_Light_curve_data.dat'
Solexs=(np.loadtxt(f'fit_results_AL1_SOLEXS_20241101_SDD2_L1_2411010000_2411010230_TEMP_EM.txt',skiprows=1,dtype='str')).transpose() #'NB08_Light_curve_data.dat'

m_cls=datetime.fromisoformat('2024-11-01T02:07:00.000')
m_cls_p=datetime.fromisoformat('2024-11-01T02:16:00.000')
hst=datetime.fromisoformat('2024-11-01T02:00:00.000')
