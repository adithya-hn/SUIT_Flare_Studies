...
ax5 = ax3.twinx()
ax11=ax1.twinx()
ax11.plot(goes_flare_df.index, goes_flare_df["xrsa"],markersize=4,marker='o',linestyle='--', color="r", label=r"$\Delta$ XRS-A")
ax11.plot(goes_flare_df.index, goes_flare_df["xrsb"],markersize=4,marker='s',linestyle='--', color="orange", label=r"$\Delta$ XRS-B")
ax1.plot(flare_df.index, flare_df["xrsa"], color="k",markersize=4,marker='o', label="XRS-A")
ax1.plot(flare_df.index, flare_df["xrsb"],markersize=4,marker='s', color="gray", label="XRS-B")
...
ax1.grid(True)
ax2.plot(df1.index, df1["temperature"], color="k",markersize=4,marker='s', label="Temperature")
...
ax3.plot(df1.index, df1["emission_measure"]/1e48,markersize=4,marker='s', color="k",label="Emission Measure")
