...
hmi_files = sorted(glob(f"/media/adithya/Adi_disk4/SUIT_flare_work/case7_nov01/data/HMI/HMI_cutouts/*.fits")) 
suit_files=sorted(glob(f'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case7_Nov01/data/aligned_crop/*NB04.fits'))
