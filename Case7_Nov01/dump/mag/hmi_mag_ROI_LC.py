...
fol_nm='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case7_Nov01/mag'
fol_nm=fol_nm+'/'+'Imgs_fm'
pathlib.Path(fol_nm).mkdir(parents=True, exist_ok=True)

search_fold='/media/adithya/Adi_disk4/SUIT_flare_work/case7_nov01/data/HMI/cut_outs/HMI_cutouts/'
...
for i in tqdm(range (len(Sequence))):
    ...
    point1 = SkyCoord(-380*u.arcsec, 150*u.arcsec, frame=hmi_map.coordinate_frame) #flull region
    ...
    point2 = SkyCoord(-180*u.arcsec, 250*u.arcsec, frame=hmi_map.coordinate_frame)
