...
aia_imgs_pth='/media/adithya/Adi_disk4/SUIT_flare_work/case7_nov01/data/aia/cut_outs/'
hmi_imgs_pth='/media/adithya/Adi_disk4/SUIT_flare_work/case7_nov01/data/hmi/HMI_cutouts/'
ref_fd_1600_pth='/media/adithya/Adi_disk4/SUIT_flare_work/case7_nov01/data/aia/aia_fd_data/aia.lev1_uv_24s.2024-11-01T002304Z.1600.image_lev1.fits'
# tx1,ty1=-500,150
# tx2,ty2=-390,250
...
th_lvs=[3200,8000,13000]  # Mg II h/k
...
for fltr2 in Filters:
    ...
    th_lvs=[mode_val*0.7,mode_val*1.5,mode_val*3]  # Mg II h/k   
    print('Mg II k threshold levels:', th_lvs)                                                                                                                                                                                                                                                                                                                
    ...
    if ref_aia_resmp.data.shape != ref_mg_rot.data.shape:
        print('AIA to SUIT Mg II dimensions not matching, resizing AIA map')
        #print('First image:', mg_map_sq[0].meta['WAVELNTH'])
        print('shapes;','AIA=',ref_baseMap.data.shape,'Mg II h',ref_mg_map.data.shape)
