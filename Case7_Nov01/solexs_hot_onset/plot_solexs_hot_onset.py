...
02-07-2026: Adding  EM vs Temperature plot for hot onset phase analysis.
"""
...
# hot_onset_time   =  [datetime.fromisoformat("2024-11-01T02:09:40"),
#                     datetime.fromisoformat("2024-11-01T02:10:20")]

fit_file='AL1_SOLEXS_20241101_SDD2_L1_puc_tb_fit_results_with_bkg_T_EM_case4.fits'
lc1_file ="/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case7_Nov01/solexs_hot_onset/AL1_SOLEXS_20241101_SDD2_L1_2.03_3.98keV_30sec.lc" #solexs 2-12 kev
lc2_file= "AL1_SOLEXS_20241101_SDD2_L1_12.08_21.99keV_30sec.lc" #solexs 12-22 kev
lc3_file= 'LightCurve.csv' #helios above 22 kev

stix_t_em=pd.read_csv('7_Nov01_stix_hot_onset_phase.csv')
...
temp=t_em[1].data['TEMPERATURE'][1:]
time_array=t_em[1].data['TIME'][1:]
# print(t_em[1].data['TIME_ERR'])
em=t_em[1].data['EM'][1:]
t_er=t_em[1].data['TEMPERATURE_ERR'][1:]
em_er=t_em[1].data['EM_ERR'][1:]
t_dt=[]
for t in time_array:
...
# ax1.annotate("Hot onset", xy=(hot_onset_time[0], ax1.get_ylim()[1]*0.7),rotation=90,
#             xytext=(5, -12), textcoords="offset points",
...
TITLE    = "EM-T Evolution (SOL2024-11-01T02:16)"
