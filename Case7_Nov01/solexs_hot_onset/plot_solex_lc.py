...
flare_start = datetime.fromisoformat("2024-11-01T02:05:00")
flare_peak  = datetime.fromisoformat("2024-11-01T02:16:00")
background_start = datetime.fromisoformat("2024-11-01T02:00:30")
background_end   = datetime.fromisoformat("2024-11-01T02:03:30")
...
plt.axvline(flare_start, color='red', linestyle='--', label='Flare Start (02:05:00 UT)')
plt.axvline(flare_peak, color='green', linestyle='--', label='Flare Peak (02:16:00 UT)')
...
plt.axvspan(background_start, background_end, color='gray', alpha=0.3, label='Background Interval (02:00:30-02:03:30 UT)')
