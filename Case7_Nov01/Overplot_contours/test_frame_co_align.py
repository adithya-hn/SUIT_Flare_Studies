...
aia_roi_files = '/media/adithya/Adi_disk4/SUIT_flare_work/case7_nov01/data/aia/cut_outs/1600_cutouts_aln/'
fltr='NB04'
fwhm = 8
sigma = fwhm / 2.355
...
for i in tqdm(range(len(fltr_fl))):
    ...
    # suit_map_rot=suit_map_rot.submap(bl,top_right=tr) #croped
    ...
    mg_aln_maps=mc_coalign(sq,layer_index=0,clip=False)##,func=np.square)# template=template,
