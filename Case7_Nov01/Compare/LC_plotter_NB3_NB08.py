...
data=(np.loadtxt(f'NB08_M1.3_Light_curve_data.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
date_array=data[0]

NB3_data=(np.loadtxt(f'NB03_M1.3_Light_curve_data.csv',delimiter=',',dtype='str')).transpose()
...
Solexs=np.loadtxt('fit_results_AL1_SOLEXS_20241101_SDD2_L1_2411010000_2411010230_TEMP_EM.txt',dtype='str',skiprows=1).transpose()
...
nb3_y_er=np.std(nb3float_array_er)
...
x_cls=datetime.fromisoformat('2024-11-01T02:05:00.000')
x_cls_p=datetime.fromisoformat('2024-11-01T02:16:00.000')
