...
star_time=Time('2024-11-01T00:22:00', scale='utc', format='isot')
end_time= Time('2024-11-01T00:22:30', scale='utc', format='isot')
out_dir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case7_Nov01/data/aia'
