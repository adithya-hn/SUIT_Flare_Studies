...
files = sorted(glob.glob("/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case7_Nov01/data/1600_aligned/*NB05.fits"))
...
x1,y1,x2,y2=120,125,620,760 #modified for cont
