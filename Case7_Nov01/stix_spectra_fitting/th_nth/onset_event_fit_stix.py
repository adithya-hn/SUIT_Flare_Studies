...
Start_t="2024-11-01T02:10:00"
End_t="2024-11-01T02:11:00"
case='7_Nov01'
event_id=5
fit_range=[4,30]
#-----------------------------------------------
...
fitter.energy_fitting_range = [fit_range[0],fit_range[1]]
fitter.params["T1_spectrum1"] = {"Status":"free", "Value":8, "Bounds":(1, 100)}
fitter.params["EM1_spectrum1"] = {"Status":"free", "Value":4, "Bounds":(1, 1000)}
...
axes[0].set_xlim([fit_range[0],fit_range[1]+10])
plt.title(f'STIX: ({Start_t} - {End_t})')
