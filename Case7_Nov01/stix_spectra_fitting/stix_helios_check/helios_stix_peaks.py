...
# Start_t="2024-11-01T00:35:30"
# End_t  ="2024-11-01T00:36:30"
start_background_time = "2024-11-01T00:55:00"
end_background_time   = "2024-11-01T01:00:00"
case='7_Nov01'
helios_pks=np.genfromtxt('helios_peaks.csv',delimiter=',', names=True, dtype=None)
pks_dt=helios_pks['date_time']
fit_mode='th_nth' #'th' 'both' 'th_nth'
...
for i in range(len(pks_dt)):
    ...
    plot_range=[datetime.fromisoformat(pks_dt[i])- timedelta(minutes=12),datetime.fromisoformat(pks_dt[i])+ timedelta(minutes=8)]
