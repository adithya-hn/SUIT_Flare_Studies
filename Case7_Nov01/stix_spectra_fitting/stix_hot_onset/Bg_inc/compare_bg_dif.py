...
End_t   = "2024-11-01T02:10:00"
thermal_data=np.genfromtxt('thermal/7_Nov01_stix_timeResolved_th_fit.csv',delimiter=',', names=True, dtype=None, encoding='utf-8')
...
non_thermal=np.genfromtxt('7_Nov01_stix_timeResolved_th_fit.csv',delimiter=',', names=True, dtype=None, encoding='utf-8')
...
ax[2].plot(dt2,L2,label='2.5 min BG')
ax[2].set_ylim(-100,5)
ax[0].set_ylabel('Temperature')
ax[1].set_ylabel('Emission measure')
ax[2].set_ylabel('Log likelihood')
# plt.xlim()
plot_range=[datetime.fromisoformat(Start_t)- timedelta(minutes=0),datetime.fromisoformat(End_t)]
