...
for i in range(2):
    ...
    def fit_th(stix_spec):
        ...
        plt.savefig(f'{case}_stix_preflarePeak_{event_id}_{fit_mode}.png',dpi=300)
        plt.close()
        ...
        plt.savefig(f'{case}_peak_{event_id}_{fit_mode}_with_mcmc.png',dpi=300)
        plt.close()
        return fitter
    ...
    if fit_mode=='th':
        ...
        print(type(th_param.show_params))
