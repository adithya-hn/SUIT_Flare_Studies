...
filter2_fold = '/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case7_Nov01/data/processed/aligned_fits/NB08/'
...
#-------------
ca_map = sunpy.map.Map('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case7_Nov01/data/processed/aligned_fits/NB08/SUT_T24_1592_000636_Lev1.0_2024-11-01T02.15.45.132_0983NB08.fits') #not sure about this
ca_map_data = ca_map.data * 1000 / ca_map.meta.get('CMD_EXPT')
ca_map.meta.update(get_observer_meta(ref_pos, rsun=ref_pos.rsun))
...
plt.imshow(ca_map_data, origin='lower', cmap='gray', vmin=0, vmax=7000)
...
for filter2_file in filter2_files:
    ...
    filter2_map.plot(vmin=0, vmax=8000)
