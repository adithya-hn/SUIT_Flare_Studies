...
peak_time=datetime(2024, 11,1 ,2,16, 0)
start_time=datetime(2024, 11,1 ,2,5, 0)
...
ax.set_xlim(50,500)
ax.set_ylim(80,500)
plt.savefig(f'{wkdir}/HMI_{fltr}_stacked_contours.pdf',dpi=400)
# plt.savefig(f'{wkdir}/HMI_{fltr}_stacked_Excess_intensity.png',dpi=400)
plt.show()
