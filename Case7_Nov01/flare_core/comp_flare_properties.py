...
flare_light_curve_files = ['NB03_M1.3_Light_curve_data.csv', 'NB04_M1.3_Light_curve_data.csv', 'NB08_M1.3_Light_curve_data.csv']

start_time_isot = '2024-11-01T02:05:00.000'
peak_time_isot = '2024-11-01T02:16:00.000'
end_time_isot = '2024-11-01T02:20:00.000'
noaa_region = 13878
goes_class = 'M1.3'
...
for file in flare_light_curve_files:
    ...
    if file=='NB08_X1.4_Light_curve_data.csv':
        plt.text(df['datetime'].min(), df['total_count'].max() * 0.96, props_text, fontsize=10,bbox=dict(facecolor='white', alpha=0.7))
    else:
