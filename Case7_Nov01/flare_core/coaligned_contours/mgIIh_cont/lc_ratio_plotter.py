...
data=(np.loadtxt(f'nb04_contours.csv',delimiter=',',skiprows=1,dtype='str')).transpose() #'NB08_Light_curve_data.dat'
...
#plt.plot(time_array,float_array_er/1.3)
#plt.plot(time_array,qs_intrep_counts)
#plt.show()
...
img_nm='c7_ratio_light_curve_nb04_nb03.png'
...
plt.title('Mg II h/Mg II k ratio Light Curves')
...
img_nm_='c7_enhnace_light_curve_nb04_nb03.png'
