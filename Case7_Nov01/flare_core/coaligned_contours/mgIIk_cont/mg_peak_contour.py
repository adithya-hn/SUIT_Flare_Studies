...
filter2_fold = '/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case7_Nov01/data/processed/aligned_fits/NB03/'
...
ax = fig.add_subplot(projection=ref_mg_map)
ref_mg_map.plot(axes=ax, cmap='gray', vmin=0, vmax=30000)
ref_mg_map.draw_quadrangle(qs_coords, axes=ax, edgecolor="blue", linestyle="-", linewidth=2, label='Region of interest')
hpc_coord=[]
