...
filter2_fold = '/Analysis/Projects_Data/Flare_Data/Nov01_Flare_Data1/Processed/Aligned_images/NB08/'
...
#-------------
ca_map = sunpy.map.Map('/Analysis/Projects_Data/Flare_Data/Nov01_Flare_Data1/Processed/Aligned_images/NB08/SUT_T24_1592_000636_Lev1.0_2024-11-01T02.15.45.132_0983NB08.fits') #not sure about this
ca_map_data = ca_map.data * 1000 / ca_map.meta.get('CMD_EXPT')
qs_coords1 =  SkyCoord(Tx=(-600, -530) * u.arcsec, Ty=(400,300)* u.arcsec, frame=ca_map.coordinate_frame)
...
for filter2_file in filter2_files:
    ...
    qs_coords3=SkyCoord(Tx=(-600, -530) * u.arcsec, Ty=(400,300)* u.arcsec, frame=filter2_map.coordinate_frame)
