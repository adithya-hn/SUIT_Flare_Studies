...
data=(np.loadtxt(f'NB08_M1.3_Light_curve_data.csv',delimiter=',',dtype='str')).transpose() #'NB08_Light_curve_data.dat'
...
axs.plot(time_array,(float_array/counts_2_interp),color=colors_list[2],marker='s',markersize=2,linewidth=0.5,label='AR ratio ')
...
axs.set_ylabel("Ca II h/Mg II k Ratio ")
