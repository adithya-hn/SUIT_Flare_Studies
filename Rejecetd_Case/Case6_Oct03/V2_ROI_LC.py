...
fdir='/Analysis/Projects_Data/Flare_Data/Oct03_Flare_Data1/Processed/Aligned_images/'
...
for fltr in Filters:
    ...
    for i in range(len(Sequence)):
        ...
        coords = SkyCoord(Tx=(-450, 7) * u.arcsec, Ty=(-26, -373) * u.arcsec, frame=suit_map.coordinate_frame)
        ...
        er_coords = SkyCoord(Tx=(-125, -25) * u.arcsec, Ty=(-11, -111) * u.arcsec, frame=suit_map.coordinate_frame)
