...
Path='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/June01_Flare/HMI_Magnetograms'
...
star_time=Time('2024-06-01T06:07:00', scale='utc', format='isot')
end_time=Time('2024-06-01T07:07:00', scale='utc', format='isot')
...
bottom_left = SkyCoord(x1*u.arcsec, y1*u.arcsec, obstime=star_time, observer="earth", frame="helioprojective")
top_right = SkyCoord(x2*u.arcsec, y2 *u.arcsec, obstime=star_time, observer="earth", frame="helioprojective")
...
series = a.jsoc.Series('hmi.M_45s')
query = Fido.search(a.Time(star_time,end_time),series,a.jsoc.Notify("adithyabhattsringeri@gmail.com"),cutout,) #adithya1@atulbhats.com
print(query)
