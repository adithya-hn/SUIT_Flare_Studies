...
flare_start = datetime.fromisoformat("2024-07-10T05:44:00")
flare_peak  = datetime.fromisoformat("2024-07-10T05:59:00")
background_start = datetime.fromisoformat("2024-07-10T05:35:30")
background_end   = datetime.fromisoformat("2024-07-10T05:38:30")
...
plt.axvline(flare_start, color='red', linestyle='--', label='Flare Start (05:44:00 UT)')
plt.axvline(flare_peak, color='green', linestyle='--', label='Flare Peak (05:59:00 UT)')
...
plt.axvspan(background_start, background_end, color='gray', alpha=0.3, label='Background Interval (05:35:30-05:38:30 UT)')
plt.legend()
plt.yscale('log')
plt.xlabel('Time')
plt.ylabel('Count rate')
plt.title('SoLEXS-HEL1OS flare onset light curves')
plt.xlim(background_start-timedelta(minutes=5), flare_peak+timedelta(minutes=3))
