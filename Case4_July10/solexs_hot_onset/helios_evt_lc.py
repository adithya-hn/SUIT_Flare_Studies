...
aa = fits.open("/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case4_July10/solexs_hot_onset/evt.fits");
...
command = [
    ...
    "--fits_file", "/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case4_July10/solexs_hot_onset/evt.fits",  
    "--mode", "CDTE_TOTAL",
    "--start_time", "2024-07-10T05:40:00.000",
    "--end_time",   "2024-07-10T06:11:00.000",
    "--time_bin_size", "30",
