...
Filters=['HMI']
#File_Source='/media/adithya/Adi_disk4/SUIT_flare_work/case4_jul10/data/HMI/HMI_FD'
...
for fltr in Filters:
    ...
    fdir='/media/adithya/Adi_disk4/SUIT_flare_work/case4_jul10/data/HMI/HMI_FD/'
