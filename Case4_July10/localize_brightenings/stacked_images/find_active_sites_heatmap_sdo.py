...
def draw_suit_contours_on_sdo(suitMap,base_map,thresh_sig,heat,clr):
    ...
    if labels.max()>1:
        ...
        cleaned=labels
    mask=cleaned>0
    heat=heat+mask.astype(int)#diff_img*
    return heat

#---------------------------------------------------------------------------------------------


peak_time=datetime(2024, 7,10 ,6,0, 0)
...
base_image='SDO' #suit
if base_image=='SDO':
    aia_fl='/media/adithya/Adi_disk4/SUIT_flare_work/case4_jul10/data/HMI/HMI_cutouts/test_set/hmi.m_45s.20240710_040045_TAI.2.magnetogram.fits' #'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case4_July10/data/aia/aia.lev1_euv_12s.2024-07-10T040010Z.171.image_lev1 (2).fits' #
