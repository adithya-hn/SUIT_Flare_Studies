...
star_time=Time('2024-07-10T03:29:00', scale='utc', format='isot')
end_time=Time('2024-07-10T03:29:30', scale='utc', format='isot')
out_dir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case4_July10/data/aia'
