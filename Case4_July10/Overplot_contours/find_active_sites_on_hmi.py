...
hmi_map_raw=Map('/media/adithya/Adi_disk4/SUIT_flare_work/case4_jul10/data/HMI/HMI_cutouts/hmi.m_45s.20240710_040000_TAI.2.magnetogram.fits')
...
points=np.loadtxt('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case4_July10/Overplot_contours/boxes.csv',delimiter=',')
