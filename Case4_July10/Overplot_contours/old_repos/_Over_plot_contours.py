...
for fltr in Filters:
    ...
    search_fold=f'/Analysis/Projects_Data/Flare_Data/July10_Flare_Data/P_corr_data/' #Custom Folder
    search_fold2=f'/Analysis/Projects_Data/Flare_Data/July10_Flare_Data/P_corr_data/'
    if fltr2=='HMI':
        base_fold=f'/Analysis/Projects_Data/Flare_Data/July10_Flare_Data/{fltr2}/{fltr2}_cutouts/'
    else:
        base_fold=f'/Analysis/Projects_Data/Flare_Data/July10_Flare_Data/AIA/{fltr2}/{fltr2}_cutouts/'
