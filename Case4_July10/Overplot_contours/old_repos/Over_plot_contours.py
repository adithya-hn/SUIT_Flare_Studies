...
for fltr in Filters:
    ...
    search_fold=f'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case4_July10/data/raw/' #Custom Folder
    #search_fold2=f'/Analysis/Projects_Data/Flare_Data/July10_Flare_Data2/P_corr_data/'
    if fltr2=='HMI':
        base_fold=f'/media/adithya/Adi_disk4/SUIT_flare_work/Flare_Data/July10_Flare_Data/{fltr2}/{fltr2}_cutouts/'
    elif fltr2=='GONG':
        base_fold=f'/Analysis/Projects_Data/Flare_Data/June01_Flare_Data/{fltr2}/{fltr2}_cutouts/'
    else:
        base_fold=f'/media/adithya/Adi_disk4/SUIT_flare_work/Flare_Data/July10_Flare_Data/AIA/{fltr2}/{fltr2}_cutouts/'
    ...
    files2 = glob.glob(search_fold + '*3'+'NB03'+'.fits')
    ...
    for i in range(len(files)):
        ...
        Mg_Map.draw_contours(axes=ax, levels=th_lvs2,zorder=2,colors=['pink','green'],alpha=0.7)
