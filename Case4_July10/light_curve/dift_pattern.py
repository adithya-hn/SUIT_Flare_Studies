...
# Load the catalogue
catalogue_path = "/Analysis/Research_Projects/SUIT_work/SUIT_Database/SUIT_Data_Jul_catalogue_2024.csv"  # your monthly CSV file
...
start_time = pd.Timestamp("2024-07-10 03:30:00")
end_time   = pd.Timestamp("2024-07-10 06:00:00")
