...
fdir='/Analysis/Projects_Data/Flare_Data/July10_Flare_Data/Processed/Aligned_images/'
...
for fltr in Filters:
    ...
    np.savetxt(f'{fltr}_M1.5_Light_curve_data.csv',np.c_[date_array,fltr_count,fltr_count_err],delimiter=',',fmt='%s')
