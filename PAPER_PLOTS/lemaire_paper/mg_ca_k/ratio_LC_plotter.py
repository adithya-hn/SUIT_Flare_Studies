...
axs.plot(time_array,float_array_er/float_array,'ko-',markersize=0.9,linewidth=0.5,label='Ratio of Ca II k/ Mg II k')
...
plt.title('Ca II k/ Mg II k ratio Light Curve')
plt.legend(loc='best')
