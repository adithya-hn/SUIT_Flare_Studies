...
data1=(np.loadtxt(f'NB03_c1_lc_data.csv',delimiter=',',skiprows=1,dtype='str')).transpose() #'NB03_Light_curve_data.dat'
data2=(np.loadtxt(f'NB08_c1_lc_data.csv',delimiter=',',skiprows=1,dtype='str')).transpose() 
data3=(np.loadtxt(f'NB04_c1_lc_data.csv',delimiter=',',skiprows=1,dtype='str')).transpose() 
