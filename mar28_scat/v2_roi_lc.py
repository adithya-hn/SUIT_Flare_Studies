...
fdir='/Analysis/Projects_Data/Flare_Data/Mar28_flare/'
cTx1=-1138
cTy1=31
cTx2=-909
cTy2=240
...
for fltr in Filters:
    ...
    np.savetxt(f'{fltr}_c3_lc_data.csv',np.c_[date_array,fltr_count,fltr_count_err,bx_area],delimiter=',',fmt='%s')
