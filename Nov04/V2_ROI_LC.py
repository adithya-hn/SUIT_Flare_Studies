...
fdir='/Analysis/Projects_Data/Flare_Data/Nov01_Flare_Data2/Processed/Aligned_images/'
...
for fltr in Filters:
    ...
    for i in range(len(Sequence)):
        ...
        coords = SkyCoord(Tx=(-450, -170) * u.arcsec, Ty=(380, 70) * u.arcsec, frame=suit_map.coordinate_frame)
        ...
        er_coords = SkyCoord(Tx=(-450, -350) * u.arcsec, Ty=(380, 280) * u.arcsec, frame=suit_map.coordinate_frame)
    ...
    np.savetxt(f'{fltr}_M2.0_Light_curve_data.csv',np.c_[date_array,fltr_count,fltr_count_err],delimiter=',',fmt='%s')
