...
- To create a light cuvre and correlation value with the helios of selected active regionn for the comparision.
...
cols_to_plot = [ "region_1", "region_4","region_6","region_7"]  # change names as needed
...
ax2.legend()
plt.xlabel("Time")
ax1.set_ylabel("HEL1OS Counts",fontsize=)
