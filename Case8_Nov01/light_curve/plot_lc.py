...
int_roi = rgn_lc_data[:, 5].astype(float)/exposure #region 5
...
ll=np.power(10,5.4)
#axs1.set_ylim(ll,ul)
axs[0].axvspan(xmin=datetime(2024,11,1,13,6),xmax=datetime(2024,11,1,13,12),color='r',alpha=0.2)
...
# Add global title
fig.suptitle(f"Flare Light Curves (SOL2024-11-01T14:31) ", fontsize=20, weight='bold')
