...
path_dir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case8_Nov01/data/aligned_crop_pngs/nb4/'
# Replace 'my_image.png' with the actual path to your image file

imgs=sorted(glob.glob(path_dir+'*.png'))

data1=(np.loadtxt(f'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case8_Nov01/light_curve/csv_files/c4_NB04_lc_data.csv',delimiter=',',skiprows=1,dtype='str')).transpose() 
