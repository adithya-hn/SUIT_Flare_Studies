...
for flt in ['NB03', 'NB04', 'NB08','flare_8']: #,
    # === USER INPUTS ===
    if flt == 'flare_8':
        ...
        input_file = f"{flt}_c8_lc_data.csv"  # your input file
    ...
    start_time = "2024-11-01T12:15:00.000"  # ISOT start time
    end_time   = "2024-11-01T12:45:00.000"    # ISOT end time
