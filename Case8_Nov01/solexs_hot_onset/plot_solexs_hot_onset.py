...
impulsive_phase_start_time = "2024-11-01T14:23:00"
goes_flare_start_time      = "2024-11-01T14:18:00"



thermal_range    = [datetime.fromisoformat("2024-11-01T14:19:00"),
...
stix_t_em=pd.read_csv('c8_stix_hotonset_phase.csv')
...
temp=t_em[1].data['TEMPERATURE'][11:]
time_array=t_em[1].data['TIME'][11:]
em=t_em[1].data['EM'][11:]
t_er=t_em[1].data['TEMPERATURE_ERR'][11:]
em_er=t_em[1].data['EM_ERR'][11:]
t_dt=[]
for t in time_array:
...
ax.set_title(f"Flare onset phase (SOL2024-11-01T14:23)")
...
plt.tight_layout()
plt.savefig("c8_solex_onset_lc.pdf", dpi=300)
plt.close()
...
TITLE    = "EM-T Evolution (SOL2024-11-01T14:23)"
