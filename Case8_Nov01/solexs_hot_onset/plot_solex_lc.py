...
lc1_file ="AL1_SOLEXS_20241101_SDD2_L1_2.03_11.99keV_30sec.lc" #solexs 2-12 kev
...
flare_start = datetime.fromisoformat("2024-11-01T14:18:00")
flare_peak  = datetime.fromisoformat("2024-11-01T14:31:00")
background_start = datetime.fromisoformat("2024-11-01T14:13:30")
background_end   = datetime.fromisoformat("2024-11-01T14:16:30")
...
plt.axvline(flare_start, color='red', linestyle='--', label='Flare Start (14:18:00 UT)')
plt.axvline(flare_peak, color='green', linestyle='--', label='Flare Peak (14:31:00 UT)')
...
plt.axvspan(background_start, background_end, color='gray', alpha=0.3, label='Background Interval (14:13:30-14:16:30 UT)')
