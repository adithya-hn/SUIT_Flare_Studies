...
def draw_suit_contours_on_sdo(suitMap,aia_map,base_map,thresh_sig,fltr,aia_dt,base_channel):
    ...
    # ax.set_ylim(10,400)
    ax.text(0.5, 0.90,str(aia_dt)[11:-4],color='w',transform=ax.transAxes,ha="center", va="center",weight='bold',fontsize=80)
...
#-----------------Intial paths and params--------------------------
    ...
    aia_imgs='/media/adithya/Adi_disk4/SUIT_flare_work/case8_nov01/data/aia/cut_outs/171_cutout_aln/'
    ...
    aia_fls = glob.glob(aia_imgs + '*.fits') #'*1600.image_lev1.fits'
