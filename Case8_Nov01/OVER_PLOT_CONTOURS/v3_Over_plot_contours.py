...
Author: adithya-hn
Purpose: Overplot contours of SUIT Mg II k and Ca II H on AIA 1600 images
...
ref_fd_1600_pth='/media/adithya/Adi_disk4/SUIT_flare_work/case8_nov01/data/aia/aia_fd_data/aia.lev1_uv_24s.2024-11-01T121304Z.1600.image_lev1.fits'
tx1,ty1=-400,130
tx2,ty2=-150,270
save_aligned='yes'
save_pngs='no'
...
for fltr2 in Filters:
    ...
    print('before',ref_mg_map.observer_coordinate.rsun)
    ...
    print('l1 sun',suit_pos.rsun)
    print('Later',ref_mg_map.observer_coordinate.rsun)
    ...
    #----------
    print('Debug mode')
    print('AIA rsun',ref_fd_1600.observer_coordinate.rsun)
    print('Shape before', ref_mg_map.data.shape) 
    print('Shape later', ref_mg_rot.data.shape) 
    print('AIA 1600 shape', ref_fd_1600.data.shape)
    print('AIA 1600 scale', ref_fd_1600.scale)  
    print('Mg II k scale', ref_mg_map.scale)

    print('AIA scale post resmapling: ',ref_aia_resmp.scale)
    print('AIA base shape:', ref_baseMap.data.shape)
    ...
    for i in range(len(files2)):
        ...
        ca_map=Map(files2[i])
        print('Rsun',ca_map.observer_coordinate.rsun)
        ...
        print('after update Rsun',ca_map.observer_coordinate.rsun)
    ...
    for j in range(len(mg_aln_maps)):
        ...
        print('Mg maps',alnMap.meta['CRPIX1'],alnMap.meta['CRPIX2'],'Ref:',mg_aln_maps[0].meta['CRPIX1'],mg_aln_maps[0].meta['CRPIX2'])
        print('Mg maps',alnMap.meta['CRVAL1'],alnMap.meta['CRVAL2'],'Ref:',mg_aln_maps[0].meta['CRVAL1'],mg_aln_maps[0].meta['CRVAL2'])
    ...
    for i in range(len(ca_aln_maps)):
        ...
        print('ca maps',alnMap.meta['CRPIX1'],alnMap.meta['CRPIX2'],'Ref:',ca_aln_maps[0].meta['CRPIX1'],ca_aln_maps[0].meta['CRPIX2'])
        print('ca maps',alnMap.meta['CRVAL1'],alnMap.meta['CRVAL2'],'Ref:',mg_aln_maps[0].meta['CRVAL1'],mg_aln_maps[0].meta['CRVAL2'])
        alnMap.meta['CRPIX1']=ca_aln_maps[0].meta['CRPIX1']+10#Important to update all to same reference
        alnMap.meta['CRPIX2']=ca_aln_maps[0].meta['CRPIX2']-5
