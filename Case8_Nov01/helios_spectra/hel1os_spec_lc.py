...
path = '/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case8_Nov01/data/helios/'
start_dt,end_dt=datetime.datetime(2024,11,1,12,31),datetime.datetime(2024,11,1,14,46)
...
lc_gt12 =np.sum((cdte1_counts[:, idx_gt12]+cdte2_counts[:, idx_gt12]), axis=1)
