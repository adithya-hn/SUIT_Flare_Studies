...
plot_range=[datetime.fromisoformat(Start_t)- timedelta(minutes=20),datetime.fromisoformat(End_t)+ timedelta(minutes=100)]
...
# fitter1.energy_fitting_range = [9,14]
...
# fitter.energy_fitting_range = [6,14]
