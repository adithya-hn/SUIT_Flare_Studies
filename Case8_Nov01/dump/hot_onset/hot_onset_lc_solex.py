...
data1=(np.loadtxt(f'c8_NB04_lc_data.csv',delimiter=',',skiprows=1,dtype='str')).transpose() #'NB03_Light_curve_data.dat'
Solexs=(np.loadtxt(f'fit_results_AL1_SOLEXS_20241101_SDD2_L1_2411011100_2411011500_TEMP_EM.txt',skiprows=1,dtype='str')).transpose() #'NB08_Light_curve_data.dat'

m_cls=datetime.fromisoformat('2024-11-01T14:18:00.000')
m_cls_p=datetime.fromisoformat('2024-11-01T14:31:00.000')
hst=datetime.fromisoformat('2024-11-01T14:10:00.000')
