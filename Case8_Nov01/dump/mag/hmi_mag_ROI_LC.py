...
fol_nm='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case8_Nov01/mag'
fol_nm=fol_nm+'/'+'Imgs_fm'
pathlib.Path(fol_nm).mkdir(parents=True, exist_ok=True)

search_fold='/media/adithya/Adi_disk4/SUIT_flare_work/case8_nov01/data/HMI/HMI_cutouts/'
