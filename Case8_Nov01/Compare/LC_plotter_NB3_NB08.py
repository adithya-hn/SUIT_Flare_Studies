...
data=(np.loadtxt(f'NB08_M2.0_Light_curve_data.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
date_array=data[0]

NB3_data=(np.loadtxt(f'NB03_M2.0_Light_curve_data.csv',delimiter=',',dtype='str')).transpose()
...
Solexs=np.loadtxt('fit_results_AL1_SOLEXS_20241101_SDD2_L1_2411011100_2411011500_TEMP_EM.txt',dtype='str',skiprows=1).transpose()
...
x_cls=datetime.fromisoformat('2024-11-01T14:18:00.000')
x_cls_p=datetime.fromisoformat('2024-11-01T14:31:00.000')
