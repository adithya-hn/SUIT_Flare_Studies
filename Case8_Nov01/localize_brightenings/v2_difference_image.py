...
flt='NB04'
p1,p2,p3,p4=50,630,100,670
data_folder=f'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case8_Nov01/data/1600_aligned/*{flt}.fits'
clip_bar=False  #to remove the ccd quadrant
c1,c2=80,120

#--------------------------------------------------------
nb3_maps=glob.glob(data_folder)
