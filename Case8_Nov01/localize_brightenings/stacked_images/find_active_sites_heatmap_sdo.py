...
base_image='SDO' #suit
if base_image=='SDO':
    aia_fl='/media/adithya/Adi_disk4/SUIT_flare_work/case8_nov01/data/HMI/HMI_cutouts/test_set/hmi.m_45s.20241101_123130_TAI.2.magnetogram.fits'#'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case4_July10/data/aia/aia.lev1_euv_12s.2024-07-10T040010Z.171.image_lev1.fits'
    hmi_imgs   = '/media/adithya/Adi_disk4/SUIT_flare_work/case8_nov01/data/HMI/HMI_cutouts/test_set/'
fltr='NB04'
thresh_sig=5
...
if base_image=='SDO':
    #im2=aia_map.plot(axes=ax,cmap=sns_cl)
...
sns_cl = sns.color_palette("gray",as_cmap=True)
...
ax.set_xlim(10,565)
ax.set_ylim(10,550)
#plt.savefig(f'c8_HMI_{fltr}_stacked_contours.pdf',dpi=300)
plt.savefig(f'c8_{fltr}_stacked_contours.pdf',dpi=300)
plt.show()
