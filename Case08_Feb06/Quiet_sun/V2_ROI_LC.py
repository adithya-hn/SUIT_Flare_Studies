...
fdir='/Analysis/Projects_Data/Flare_Data/Feb06_flare_data/Processed/Aligned_images/'
...
for fltr in Filters:
    ...
    for i in range(len(Sequence)):
        ...
        suit_map.plot(axes=ax,vmin=Imin, vmax=Imax)
        coords = SkyCoord(Tx=txR * u.arcsec, Ty=tyR * u.arcsec, frame=suit_map.coordinate_frame)
        ...
        er_coords = SkyCoord(Tx=(190, 290) * u.arcsec, Ty=(20, 120) * u.arcsec, frame=suit_map.coordinate_frame)
        ...
        suit_box.plot(axes=ax, vmin=Imin, vmax=Imax)
        plt.colorbar()
        ...
        fltr_count_err.append(np.sum(er_box.data)/er_area)
