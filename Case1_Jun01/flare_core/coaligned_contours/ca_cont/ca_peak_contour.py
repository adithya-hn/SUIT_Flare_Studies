...
filter2_fold = '/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case1_Jun01/data/cropped/crop_fits/NB08/'
...
ca_map=sunpy.map.Map('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case1_Jun01/data/cropped/crop_fits/NB08/SUT_T24_0785_000396_Lev1.0_2024-06-01T07.10.59.336_0973NB08.fits')
...
im=plt.imshow(ca_map.data, origin='lower', cmap='gray', vmin=0, vmax=12000)
ca_map.draw_quadrangle(qs_coords1, axes=ax, edgecolor="blue", linestyle="-", linewidth=2, label='Mg-II h Flare contour')
hpc_coord=[]
...
for filter2_file in filter2_files:
    ...
    filter2_map.plot(vmin=0, vmax=12000)
