...
ref_mg_map = sunpy.map.Map('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case1_Jun01/data/raw/Jun01_1/SUT_T24_0785_000396_Lev1.0_2024-06-01T08.46.29.783_0983NB03.fits')
ref_pos = get_horizons_coord(57754, ref_mg_map.date)
...
test_map=sunpy.map.Map('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case1_Jun01/data/raw/Jun01_1/SUT_T24_0785_000396_Lev1.0_2024-06-01T07.14.12.134_0973NB03.fits')
...
for filter2_file in filter2_files:
    ...
    filter2_pos = get_horizons_coord(57754, filter2_map.date)
