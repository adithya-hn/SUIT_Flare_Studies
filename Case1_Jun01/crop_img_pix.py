...
#  crop manulally using pixel coordinates
...
for fltr in Filters:
    ...
    for k in range(len(files)):
        ...
        size=(suit_map.data).shape
        if size[0]==704:
            suit_map_data=suit_map.data[32:672,64:]
            suit_map=sunpy.map.Map(suit_map_data,suit_map.meta)
        crop_maps.append(suit_map)
        suit_map
        fig = plt.figure()
