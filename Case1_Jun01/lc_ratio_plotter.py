...
data=(np.loadtxt(f'NB08_X1.4_Light_curve_data.csv',delimiter=',',skiprows=1,dtype='str')).transpose() #'NB08_Light_curve_data.dat'
NB3_data=(np.loadtxt(f'NB03_X1.4_Light_curve_data.csv',delimiter=',',skiprows=1,dtype='str')).transpose()
