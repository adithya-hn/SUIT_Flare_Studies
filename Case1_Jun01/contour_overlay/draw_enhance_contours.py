...
def draw_suit_contours_on_sdo(suitMap,aia_map,base_map,thresh_sig,fltr,aia_dt,base_channel):
    ...
    if base_channel=='HMI':
        aia_map.draw_contours(axes=ax,levels=0,colors='green',lw=1,alpha=0.4)
...
#-----------------Intial paths and params--------------------------
    ...
    hmi_imgs='/media/adithya/Adi_disk4/SUIT_flare_work/case1_jun01/data/HMI/HMI_cutouts/'
