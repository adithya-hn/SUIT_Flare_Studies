...
Filters=['6173']
# suit_filters=['NB01','NB02','NB05','NB06','NB07','NB08']
...
ref_fd_img_pth='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case1_Jun01/data/aia/aia.lev1_uv_24s.2024-06-01T070952Z.1600.image_lev1.fits'
...
for fltr in suit_filters:
    ...
    if len(fltr_fl)==0:
        ...
        continue
    align_suit_fltr_to_aia.co_align_maps(suit_raw_files,jpg_fold,ref_fd_img_pth,fltr,fltr_fl,tx1,tx2,ty1,ty2,save_pngs,save_aligned_fits,draw_contours,cor_x=shift_x,cor_y=shift_y)
    print('-------------')