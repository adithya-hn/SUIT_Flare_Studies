...
Filters=['HMI']
File_Source='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case2_June02/data/hmi/HMI'
...
for fltr in Filters:
    ...
    fdir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case2_June02/data/hmi/HMI/'
