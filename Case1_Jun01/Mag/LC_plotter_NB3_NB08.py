...
NB3_data=(np.loadtxt(f'Th_secondBox__X1.4_Light_curve_data.csv',delimiter=',',dtype='str')).transpose()
...
ax2.plot(nb3_time_array,list(map(int,nb3float_array)),'bo-',markersize=2,linewidth=0.5,label='HMI')
#ax2.plot(nb3_time_array,hmi_data,'bo--',markersize=2,linewidth=0.5)
ax2.set_ylabel("HMI Total count ")
axs.set_ylabel('NB08 Total count ')
ax2.set_yscale('log')
ax2.set_ylim(6e3,2e5)
...
plt.title('LOS magnetic filed and NB08 Light Curve')
