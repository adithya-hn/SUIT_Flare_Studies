...
data=(np.loadtxt(f'Th_fullbox_magnetogram_X1.4_Light_curve_data.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
...
m_cls=datetime.fromisoformat('2024-06-01T08:26:00.000')
