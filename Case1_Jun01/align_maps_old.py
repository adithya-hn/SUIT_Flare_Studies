...
search_fold=fol_nm+'/raw/'

ref_img_=sunpy.map.Map('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case1_Jun01/data/raw/SUT_T24_0785_000396_Lev1.0_2024-06-01T09.19.31.631_0983NB03.fits')
...
coords = SkyCoord(Tx=(ll.Tx.value+30,tr.Tx.value-60) * u.arcsec, Ty=(ll.Ty.value+60,tr.Ty.value-60) * u.arcsec, frame=scaled_map.coordinate_frame)
