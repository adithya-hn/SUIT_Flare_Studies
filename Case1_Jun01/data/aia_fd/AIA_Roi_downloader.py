...
Path='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case1_Jun01/data/aia_fd'
...
start_time=Time('2024-06-01T07:00:00', scale='utc', format='isot')
end_time=Time('2024-06-01T09:15:00', scale='utc', format='isot')
