...
files = sorted(glob("/media/adithya/Adi_Disk3/SUIT_flare_work/June01_Flare/AIA_Data/aia_data/aia.lev1_euv_12s*193.image_lev1.fits")) 
...
np.savetxt('193_lc.csv',np.c_[times,intensities],fmt='%s',header='Date,Intensity')
plt.figure(figsize=(10, 5))
plt.plot(times, intensities, marker='o',markersize=0.5)
plt.gcf().autofmt_xdate()
plt.xlabel("Time")
plt.ylabel("Total Intensity (within 95% R$_\odot$)")
plt.title("AIA 193 Å Light Curve (Disk Only)")
plt.grid(True)
plt.show()