...
ax3.errorbar(dt1,count1,yerr=np.sqrt(count1)/area,fmt='tab:blue',capsize=2,markersize=1,linewidth=0.5,label='131 roi')
axs.errorbar(dt2,count2,yerr=np.sqrt(count2),capsize=2,fmt='tab:green',markersize=1,linewidth=0.5,label='171 roi')
ax2.errorbar(dt4,count4,yerr=np.sqrt(count4),capsize=2,fmt='tab:purple',markersize=1,linewidth=0.5,label='94 roi')
ax5.errorbar(dt5,count5,yerr=np.sqrt(count5),fmt='ko-',capsize=2,markersize=1,linewidth=0.5,label='1600 roi')
