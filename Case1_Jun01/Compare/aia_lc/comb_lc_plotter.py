...
data1=(np.loadtxt(f'131_fd_lc.csv',delimiter=',',dtype='str')).transpose()
data2=(np.loadtxt(f'171_fd_lc.csv',delimiter=',',dtype='str')).transpose()
data3=(np.loadtxt(f'193_roi_lc.csv',delimiter=',',dtype='str')).transpose()
#data4=(np.loadtxt(f'94_fd_lc.csv',delimiter=',',dtype='str')).transpose()
#data5=(np.loadtxt(f'1600_fd_lc.csv',delimiter=',',dtype='str')).transpose()
...
ax3.errorbar(dt1,count1,yerr=np.sqrt(count1)/area,fmt='tab:blue',capsize=2,markersize=1,linewidth=0.5,label='131 fd')
axs.errorbar(dt2,count2,yerr=np.sqrt(count2),capsize=2,fmt='tab:green',markersize=1,linewidth=0.5,label='171 fd')
ax2.errorbar(dt3,count3,yerr=np.sqrt(count3),capsize=2,fmt='tab:purple',markersize=1,linewidth=0.5,label='193 fd')
#ax5.errorbar(dt5,count5,yerr=np.sqrt(count5),fmt='ko-',capsize=2,markersize=1,linewidth=0.5,label='1600 fd')
...
img_nm='fd_comb_lc.png'
plt.title('Full disc Light Curve')
#
