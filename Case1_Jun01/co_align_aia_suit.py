...
fol_nm='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case1_Jun01/data/cropped/crop_fits'
ref_dir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case1_Jun01'
start = timeit.default_timer()
now = datetime.datetime.now()-timedelta(days=1)

jpg_fold=ref_dir+'/data/processed/'+'coloured_imgs'
algn_dir=ref_dir+'/data/processed/'+'aligned_fits'
...
search_fold=fol_nm
nb3_files = sorted(glob.glob('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case1_Jun01/data/cropped/crop_fits/NB08/' + '*3NB08.fits'))
...
for fltr in Filters:
    ...
    files = sorted(glob.glob(search_fold + f'/{fltr}/*3{fltr}.fits'))
    #print(search_fold + f'/{fltr}/*3{fltr}.fits')
