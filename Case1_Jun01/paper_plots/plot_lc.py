...
data2=(np.loadtxt(f'NB08_X1.4_Light_curve_data.csv',delimiter=',',dtype='str')).transpose() #'NB08_Light_curve_data.dat'
data3=(np.loadtxt(f'NB04_X1.4_Light_curve_data.csv',delimiter=',',dtype='str')).transpose() #'NB04_Light_curve_data.dat'

m_cls=datetime.fromisoformat('2024-06-01T08:44:00')
m_cls_p=datetime.fromisoformat('2024-06-01T08:58:00')
...
plt.xlabel(f"Time (HH:MM)",fontsize=13)
