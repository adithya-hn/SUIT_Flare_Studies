...
save_dir = '/home/adithya/Research_Projects/Flare_studies/SUIT_Flares/May31_Flare/SHARP_Data/Non_CEA'
email_id = 'munjibam@gmail.com'

data = (pd.read_csv('/home/adithya/Research_Projects/Flare_studies/SUIT_Flares/May31_Flare/Suit_flare_Sharp_downloadList.csv', sep=',')).transpose()
Data=data.values
Ts=Data[2]
novaa_num=Data[1]
Harp_num=Data[0]
    ...
    if harp:
        ...
        if len(os.listdir(ts_dir)) < 9 :    
            ...
            for parameters in tqdm(pars):
                query_string = 'hmi.sharp_720s'+'['+str(harp)+']'+'['+qry_date+']' +parameters
                #print(query_string)
