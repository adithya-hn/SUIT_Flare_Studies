...
data=(np.loadtxt(f'{param}_M1.1_Light_curve_data.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
#print(data[0])
...
m_cls=datetime.fromisoformat('2024-11-03T08:39:00.000')
#m_cls=datetime.fromisoformat('2024-06-01T08:29:00.000')
m_cls_p=datetime.fromisoformat('2024-11-03T08:49:00.000')
