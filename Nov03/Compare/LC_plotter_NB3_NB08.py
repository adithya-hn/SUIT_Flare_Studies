...
data=(np.loadtxt(f'NB08_M1.1_Light_curve_data.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
date_array=data[0]

NB3_data=(np.loadtxt(f'NB03_M1.1_Light_curve_data.csv',delimiter=',',dtype='str')).transpose()
NB3_date_array=NB3_data[0]

Helios=(np.load("cdte_data_flare_9.npy", allow_pickle=True)).transpose()
...
Solexs=np.loadtxt('fit_results_AL1_SOLEXS_20241103_SDD2_L1_2411030645_2411030915_TEMP_EM.txt',dtype='str',skiprows=1).transpose()
...
x_cls=datetime.fromisoformat('2024-11-03T08:39:00.000')
x_cls_p=datetime.fromisoformat('2024-11-03T08:49:00.000')

#axs2[0,0].plot(AR_I,AR_M,'ko',markersize=1.5)
Flt=param
axis_title='Total count'
img_nm='comb_light_curve.png'
