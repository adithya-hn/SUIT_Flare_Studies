...
fdir='/Analysis/Projects_Data/Flare_Data/Flare_Quiet_case/Oct17/Processed/Aligned_images/'
...
for fltr in Filters:
    ...
    for i in range(len(Sequence)):
        ...
        coords = SkyCoord(Tx=(200, 500) * u.arcsec, Ty=(550, 250) * u.arcsec, frame=suit_map.coordinate_frame)
        ...
        er_coords = SkyCoord(Tx=(90, 200) * u.arcsec, Ty=(240, 150) * u.arcsec, frame=suit_map.coordinate_frame)
