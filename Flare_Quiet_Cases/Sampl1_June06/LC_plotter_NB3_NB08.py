...
axs.plot(time_array,list(map(int,float_array_er)),'go-',markersize=2,linewidth=0.5,label='NB08')
ax2.plot(nb3_time_array,list(map(int,nb3float_array_er)),'ro-',markersize=2,linewidth=0.5,label='NB03')
