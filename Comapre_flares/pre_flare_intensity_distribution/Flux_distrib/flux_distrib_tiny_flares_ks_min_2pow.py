...
model_ccdf = 0.48 * (Efit / Emin_opt) ** (-(alpha_final - 1))

ccdf = empirical_ccdf(E_)
...
plt.loglog(E_, ccdf, '+',color='k', label='SUIT transeint events')
plt.loglog(Efit, model_ccdf, '-',linewidth=2,label=fr'Power-law fit (alpha = {alpha_final:.2f}$\pm$ {sigma_alpha:.2f} )')
