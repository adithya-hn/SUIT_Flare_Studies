...
@Description
-----------
Brief description: Fitting MLE power-law based fit, optimised with KS distance method.
x-ray peaks not added, broken power-law attempeted- commented out
...
plt.xlabel('Peak excess Mg II h counts',fontsize=20)
plt.ylabel(r'N($\geq$Counts)',fontsize=20)
