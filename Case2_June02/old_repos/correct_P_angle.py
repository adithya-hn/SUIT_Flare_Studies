...
fol_nm='/Analysis/Projects_Data/Flare_Data/June02_Flare_Data2/'
jpg_fold=fol_nm+'/'+'P_corr_data'

search_fold='/Analysis/Projects_Data/Flare_Data/June02_Flare_Data2/'
fdir =search_fold 
...
for i in range (len(files)):
    ...
    suitMap.meta['CRPIX1']=abs(suitMap.meta.get('CRVAL1')/0.698)+320
    suitMap.meta['CRPIX2']=abs(suitMap.meta.get('CRVAL2')/0.698)+320
