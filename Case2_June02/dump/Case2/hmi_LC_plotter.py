...
Filters=['magnetogram'] #,'Shear','TOTPOT','USJH',magnetogram
param=Filters[0]
pathlib.Path("Figures").mkdir(parents=True, exist_ok=True) 

data=(np.loadtxt(f'{param}_M1.2_Light_curve_data.csv',delimiter=',',dtype='str')).transpose()
date_array=data[0]
...
x_cls_p=datetime.fromisoformat('2024-06-02T04:50:00.000')
#m_cls=datetime.fromisoformat('2024-06-01T08:29:00.000')
x_cls=datetime.fromisoformat('2024-06-02T04:41:00.000')
