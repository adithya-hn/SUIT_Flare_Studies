...
start_time = '2024-06-02 04:40'
end_time =   '2024-06-02 04:55'
impulsive_phase_start = '2024-06-02 04:48'
...
ax4.axhline(5, color="r", ls="--", lw=1)
ax2.set_ylabel("Temperature (MK)")
ax2.legend(loc="upper right")

if trigger_time is not None:
    ax2.axvline(trigger_time, color="b", ls="--", lw=1,label="HOPE trigger")
...
ax5.axhline(5e-4, color="r", ls="--", lw=1)
...
ax5.set_ylabel(r"$\Delta$ Emission Measure ($10^{50}$ cm$^{-3}$)",color='red')
