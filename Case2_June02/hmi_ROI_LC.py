...
fol_nm='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case2_June02'
fol_nm=fol_nm+'/'+'SHARP_imgs'
pathlib.Path(fol_nm).mkdir(parents=True, exist_ok=True)


search_fold='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case2_June02/SHARP_data/13697/'
