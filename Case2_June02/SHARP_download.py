...
save_dir = '/Analysis/Research_Projects/Flare_studies/SUIT_Flares/June02_Flare/SHARAP_data/'
email_id = 'adithyabhattsringeri@gmail.com'

data = (pd.read_csv('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/June02_Flare/Suit_flare_Sharp_downloadList.csv', sep=',')).transpose()
Data=data.values
Ts=Data[2]
novaa_num=Data[1]
Harp_num=Data[0]
