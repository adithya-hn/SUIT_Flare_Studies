...
Path='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/June02_Flare/AIA_Data/Data_171'
...
query = Fido.search(a.Time(peaktime - 110*u.min, peaktime + 5*u.min),series,a.Wavelength(1600*u.angstrom),a.jsoc.Notify("adithya1@atulbhats.com"),cutout,) #a.
print(query)
