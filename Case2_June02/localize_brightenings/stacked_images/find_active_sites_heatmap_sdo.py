...
start_time=datetime.datetime(2024, 11,1 ,2,5, 0)
...
base_image='SDO' #suit
if base_image=='SDO':
    aia_fl='/media/adithya/Adi_disk4/SUIT_flare_work/case7_nov01/data/HMI/HMI_cutouts/1/hmi.m_45s.20241101_001630_TAI.2.magnetogram.fits'#'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case4_July10/data/aia/aia.lev1_euv_12s.2024-07-10T040010Z.171.image_lev1.fits'
    hmi_imgs   = '/media/adithya/Adi_disk4/SUIT_flare_work/case7_nov01/data/HMI/HMI_cutouts/1/'
fltr='NB04'
thresh_sig=5
...
ax.set_xlim(10,450)
ax.set_ylim(80,500)
plt.savefig(f'c7_HMI_{fltr}_stacked_contours.pdf',dpi=300)
#plt.savefig(f'c7_{fltr}_stacked_contours.pdf',dpi=300)
plt.show()
