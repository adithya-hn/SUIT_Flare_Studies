...
if __name__=="__main__":
    ...
    start_time = datetime(2024, 6, 2, 2, 40, 0)
    end_time = datetime(2024, 6, 2, 5, 10, 0)
    filtered_files = list_files_in_time_range(csv_file, start_time, end_time,img_type='ROI',Filter='NB03')
    np.savetxt('Flare_files_Jun2_M1.2.dat',filtered_files , delimiter=',', header='File names', fmt='%s')

    map_movie(filtered_files,Filter='NB03',start_time=start_time,end_time=start_time)
