...
data=(np.loadtxt(f'NB08_c2_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
date_array=data[0]

NB3_data=(np.loadtxt(f'NB03_c2_lc_data.csv',delimiter=',',dtype='str')).transpose()
...
Solexs=np.loadtxt('fit_results_AL1_SOLEXS_20240602_SDD2_L1_2406020230_2406020530_TEMP_EM.txt',dtype='str',skiprows=1).transpose()
...
y_er_NB3=np.sqrt(nb3float_array)
...
plt.plot(helio_time_array,cdte1)
plt.plot(helio_time_array,cdte2)
plt.close()