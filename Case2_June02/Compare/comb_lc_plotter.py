...
data3=(np.loadtxt(f'NB03_c2_lc_data.csv',delimiter=',',dtype='str')).transpose()
data4=(np.loadtxt(f'NB08_c2_lc_data.csv',delimiter=',',dtype='str')).transpose()
data5=(np.loadtxt(f'131_fd_lc.csv',delimiter=',',dtype='str')).transpose()
#data4=(np.loadtxt(f'NB08_c2_lc_data.csv',delimiter=',',dtype='str')).transpose()

csv_filename = "goes_xray_lightcurve_20240602_1.csv"
...
ax2.errorbar(dt3,count3,yerr=np.sqrt(count3),capsize=2,fmt='tab:purple',markersize=1,linewidth=0.5,label='Mg II k')
ax5.errorbar(dt5,count5,yerr=np.sqrt(count5),fmt='ko-',capsize=2,markersize=1,linewidth=0.5,label='131')
