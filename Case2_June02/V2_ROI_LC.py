...
fdir='/Analysis/Projects_Data/Flare_Data/June02_Flare_Data1/Processed/Aligned_images/'
...
for fltr in Filters:
    ...
    for i in range(len(Sequence)):
        ...
        coords = SkyCoord(Tx=(-380, -200) * u.arcsec, Ty=(-180, -350) * u.arcsec, frame=suit_map.coordinate_frame)
    ...
    np.savetxt(f'{fltr}_M1.2_Light_curve_data.csv',np.c_[date_array,fltr_count,fltr_count_err],delimiter=',',fmt='%s')
