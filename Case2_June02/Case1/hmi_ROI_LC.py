...
fol_nm='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/June02_Flare/Case1'
fol_nm=fol_nm+'/'+'SHARP_imgs'
pathlib.Path(fol_nm).mkdir(parents=True, exist_ok=True)


search_fold='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/June02_Flare/SHARP_data/13697/'
...
for param in key:
    ...
    np.savetxt(f'{param}_M2.1_Light_curve_data.csv',np.c_[date_array,fltr_count],delimiter=',',fmt='%s')
