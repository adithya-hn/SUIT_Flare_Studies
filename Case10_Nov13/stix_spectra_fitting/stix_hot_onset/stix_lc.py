...
stix_spec.update_event_times(start=Time("2024-11-13T13:20:00"), end=Time("2024-11-13T13:21:00"))
...
plt.axvline(datetime.fromisoformat("2024-11-13T17:04:20"),ls='--',lw=2,color='b',label='Impuslive phase start time',alpha=0.7)
