...
flare_start = Time("2024-11-13T17:02:00")
flare_end   = Time("2024-11-13T17:10:00")
#---------------Input parameters----------------
...
start_background_time = "2024-11-13T16:50:00"
end_background_time   = "2024-11-13T16:54:00"
...
columns = ["time_start", "time_end", "T1", "T1_er1", "T1_er2",  "T2", "T2_er1", "T2_er2", 
           "EM1", "EM1_er1", "EM1_er2","EM2", "EM2_er1", "EM2_er2",
...
while t < flare_end:
    ...
    fitter.params["T1_spectrum1"] = {"Value": 10, "Bounds": (13, 20), "Status": "free"}
    ...
    spec_mcmc = fitter.run_mcmc(number_of_walkers=12, steps_per_walker=1200,)
    ...
    th_nth_param=fitter
    T1,(T1_er1,T1_er2)=th_nth_param.show_params[0]['Value'],th_nth_param.show_params[0]['Error']
    EM1,(EM1_er1,EM1_er2)=th_nth_param.show_params[1]['Value'],th_nth_param.show_params[1]['Error']
    T2,(T2_er1,T2_er2)=th_nth_param.show_params[2]['Value'],th_nth_param.show_params[2]['Error']
    EM2,(EM2_er1,EM2_er2)=th_nth_param.show_params[3]['Value'],th_nth_param.show_params[3]['Error']
    Flux,(F_er1,F_er2)=th_nth_param.show_params[4]['Value'],th_nth_param.show_params[4]['Error']
    Index,(I_er1,I_er2)=th_nth_param.show_params[5]['Value'],th_nth_param.show_params[5]['Error']
    Ecut,(Ec_er1,Ec_er2)=th_nth_param.show_params[6]['Value'],th_nth_param.show_params[6]['Error']
    L=th_nth_param.show_params[5]['Value']
    row_nth = [t0.isot,t1.isot,T1,T1_er1,T1_er2,T2,T2_er1,T2_er2,EM1,EM1_er1,EM1_er2,EM2,EM2_er1,EM2_er2,Flux,F_er1,F_er2, Index,I_er1,I_er2,Ecut,Ec_er1,Ec_er2,L]
    # print(row_nth)
