...
fit_file='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case10_Nov13/solexs_hot_onset/AL1_SOLEXS_20241113_SDD2_L1_puc_tb_fit_results_with_bkg_T_EM_case7.fits'
lc1_file ="/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case10_Nov13/solexs_hot_onset/AL1_SOLEXS_20241113_SDD2_L1_2.03_11.99keV_30sec.lc" #solexs 2-12 kev
...
suit_int=pd.read_csv('c10_NB04_lc_data.csv')

Start_t = "2024-11-13T16:52:00"
...
ax.axvline(datetime.fromisoformat("2024-11-13T16:57:00"),ls='--',lw=1,color='b',label='GOES flare start time',alpha=0.7)
ax.axvline(datetime.fromisoformat("2024-11-13T17:04:00"),ls='-',lw=1,color='b',label='Impuslive phase start time',alpha=0.7)
...
ax.set_title(f"Flare onset phase (SOL2024-11-13T17:04:00L)", fontsize=10)
...
ax21=ax2.twinx()
xe=10/86400
ax1.errorbar(pd.to_datetime(t_dt),temp,xerr=timedelta(seconds=10),yerr=t_er,ls='dotted',color='tab:red',label='Temperature')
ax11.errorbar(pd.to_datetime(t_dt),em,xerr=timedelta(seconds=10),yerr=em_er,ls='dotted',color='tab:blue',label='Emission measure')
...
plt.tight_layout()
plt.savefig("c5_stix_onset_lc.pdf", dpi=300)
plt.show()
