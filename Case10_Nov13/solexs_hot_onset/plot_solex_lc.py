...
lc1_file ="AL1_SOLEXS_20241113_SDD2_L1_2.03_11.99keV_30sec.lc" #solexs 2-12 kev
lc2_file= "AL1_SOLEXS_20241113_SDD2_L1_12.08_21.99keV_30sec.lc" #solexs 12-22 kev
...
flare_start = datetime.fromisoformat("2024-11-13T16:57:00")
flare_peak  = datetime.fromisoformat("2024-11-13T17:08:00")
background_start = datetime.fromisoformat("2024-11-13T16:53:00")
background_end   = datetime.fromisoformat("2024-11-13T16:56:00")
...
plt.axvline(flare_start, color='red', linestyle='--', label='Flare Start (16:57:00 UT)')
plt.axvline(flare_peak, color='green', linestyle='--', label='Flare Peak (17:08:00 UT)')
...
plt.axvspan(background_start, background_end, color='gray', alpha=0.3, label='Background Interval (16:53:00-16:56:00 UT)')
