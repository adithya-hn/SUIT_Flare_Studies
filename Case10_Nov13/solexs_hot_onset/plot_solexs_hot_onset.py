...
impulsive_phase_start_time = "2024-11-13T17:04:20"
goes_flare_start_time      = "2024-11-13T16:57:00"
TITLE    = "EM-T Evolution (SOL2024-11-13T17:08)"

thermal_range    = [datetime.fromisoformat("2024-11-13T16:15:30"),
                    datetime.fromisoformat("2024-11-13T17:04:00")]

nonthermal_range = [datetime.fromisoformat("2024-11-13T17:04:00"),
                    datetime.fromisoformat("2024-11-13T17:08:00")]
...
stix_t_em=pd.read_csv('c10_stix_hotonset_phase.csv')
...
ax.set_title(f"Flare onset phase (SOL2024-11-13T17:08)")
...
plt.tight_layout()
plt.savefig("c10_solex_onset_lc.pdf", dpi=300)
plt.close()
