...
fdir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case10_Nov13/data/aligned_crop/'
...
for fltr in Filters:
    ...
    for i, suit_map in enumerate(Sequence):
        ...
        threshold = mode_val * 3  # Threshold for brightening detection
        if fltr == 'NB08':
        ...
        plt.imshow(data> threshold, origin='lower', cmap='gray', vmin=mode_val, vmax=mode_val*3)
    ...
    # Save light curve
    np.savetxt(f'csv_files/c10_{fltr}_lc_data.csv',
