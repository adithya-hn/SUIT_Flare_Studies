...
Solexs=(np.loadtxt(f'csv_files/fit_results_AL1_SOLEXS_20241113_SDD2_L1_2411131500_2411131730_TEMP_EM.txt',skiprows=1,dtype='str')).transpose()
...
axs[0].errorbar(time_array1[nb3_c1:nb3_c2], (lc1_mean)[nb3_c1:nb3_c2],yerr=lc1_mean_er[nb3_c1:nb3_c2],fmt='tab:blue', marker="o",capsize=2,markersize=2,linewidth=0.5); axs[0].legend(loc='lower right')
axs[0].errorbar(time_array1[nb3_c2:nb3_c3], (lc1_mean)[nb3_c2:nb3_c3],yerr=lc1_mean_er[nb3_c2:nb3_c3],fmt='tab:blue', marker="o",capsize=2,markersize=2,linewidth=0.5); axs[0].legend(loc='lower right')
axs[0].errorbar(time_array1[nb3_c3:], (lc1_mean)[nb3_c3:],yerr=lc1_mean_er[nb3_c3:],fmt='tab:blue', marker="o",capsize=2,markersize=2,linewidth=0.5); axs[0].legend(loc='lower right')

axs[1].errorbar(time_array2[:nb8_c0], (lc2_mean)[:nb8_c0],yerr=lc2_mean_er[:nb8_c0],fmt='black', marker="o",capsize=2,markersize=2,linewidth=0.5, label="SUIT Ca II H"); axs[1].legend(loc='lower right')
#axs[1].errorbar(time_array2[nb8_c0:nb8_c1], (lc2_mean)[nb8_c0:nb8_c1],yerr=lc2_mean_er[nb8_c0:nb8_c1],fmt='black', marker="o",capsize=2,markersize=2,linewidth=0.5, label="SUIT Ca II H"); axs[1].legend(loc='lower right')
...
axs[1].errorbar(time_array2[nb8_c2:nb8_c3], (lc2_mean)[nb8_c2:nb8_c3],yerr=lc2_mean_er[nb8_c2:nb8_c3],fmt='black', marker="o",capsize=2,markersize=2,linewidth=0.5); axs[1].legend(loc='lower right')
axs[1].errorbar(time_array2[nb8_c3:nb8_c4], (lc2_mean)[nb8_c3:nb8_c4],yerr=lc2_mean_er[nb8_c3:nb8_c4],fmt='black', marker="o",capsize=2,markersize=2,linewidth=0.5); axs[1].legend(loc='lower right')
axs[1].errorbar(time_array2[nb8_c4:], (lc2_mean)[nb8_c4:],yerr=lc2_mean_er[nb8_c4:],fmt='black', marker="o",capsize=2,markersize=2,linewidth=0.5); axs[1].legend(loc='lower right')
...
axs1.plot(time_array5[nb3_c1:nb3_c2],nb3_counts[nb3_c1:nb3_c2],'y')
axs1.plot(time_array5[nb3_c2:nb3_c3],nb3_counts[nb3_c2:nb3_c3],'y')
axs1.plot(time_array5[nb3_c3:],nb3_counts[nb3_c3:],'y')
axs2.plot(time_array6[:nb8_c0],nb8_counts[:nb8_c0],'y')
axs2.plot(time_array6[nb8_c1:nb8_c2],nb8_counts[nb8_c1:nb8_c2],'y')
axs2.plot(time_array6[nb8_c2:nb8_c3],nb8_counts[nb8_c2:nb8_c3],'y')
axs2.plot(time_array6[nb8_c3:nb8_c4],nb8_counts[nb8_c3:nb8_c4],'y')
axs2.plot(time_array6[nb8_c4:],nb8_counts[nb8_c4:],'y')
