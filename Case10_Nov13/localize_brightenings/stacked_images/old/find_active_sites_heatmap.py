...
start_time=datetime.datetime(2024, 11,13 ,15,8, 0)
suit_aligned_files= '/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case10_Nov13/data/aligned_crop/'
pk_img="/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case10_Nov13/data/aligned_crop/SUT_T24_1592_000653_Lev1.0_2024-11-13T17.05.25.449_0973NB04.fits"
aia_fl='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case10_Nov13/data/aia/aia.lev1_euv_12s.2024-11-13T150810Z.171.image_lev1.fits'
fltr='NB02'
thresh_sig=3
...
plt.savefig(f'startdt_{fltr}_stacked_contours.png',dpi=300)#aia_171_
plt.show()
