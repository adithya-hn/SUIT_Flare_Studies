...
peak_time=datetime(2024, 11,13 ,17,8, 0)
start_time=datetime(2024, 11,13 ,16,57, 0)
suit_aligned_files= '/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case10_Nov13/data/aligned_crop_fits/'
pk_img="/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case10_Nov13/data/aligned_crop_fits/SUT_T24_1592_000653_Lev1.0_2024-11-13T17.05.44.809_0973NB04.fits"
base_image='SDO' #suit
if base_image=='SDO':
...
im=ax.imshow(heat_masked, origin='lower', cmap='rainbow', alpha=0.4)
...
# plt.savefig(f'{wkdir}/HMI_{fltr}_stacked_excess_int_contours.png',dpi=400)
plt.show()
