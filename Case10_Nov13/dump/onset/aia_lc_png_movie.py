...
path_dir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case10_Nov13/onset/aia_contours/1600/'
...
plt.tight_layout()
ani.save("1600_lc_suit_aia_image.gif", writer='ffmpeg',dpi=300, fps=5)
plt.show()