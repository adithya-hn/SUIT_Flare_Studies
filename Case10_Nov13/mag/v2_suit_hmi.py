...
hmi_files = sorted(glob(f"/media/adithya/Adi_disk4/SUIT_flare_work/case10_nov13/data/HMI/HMI_cutouts/*.fits")) 
suit_files=sorted(glob(f'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case10_Nov13/data/aligned_crop/*NB04.fits'))
