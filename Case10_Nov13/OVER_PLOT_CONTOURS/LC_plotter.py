...
data=(np.loadtxt(f'mgIIh_contours.csv',delimiter=',',dtype='str',skiprows=1)).transpose() #'NB03_Light_curve_data.dat'
#print(data[0])
...
axs.scatter(time_array,list(map(int,float_array)),s=4,linewidth=0.5,label='Mg II h')
'''
