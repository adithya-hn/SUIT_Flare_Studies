...
path_dir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case10_Nov13/OVER_PLOT_CONTOURS/Contour_imgs/171/'
# Replace 'my_image.png' with the actual path to your image file

imgs=sorted(glob.glob(path_dir+'*.jpg'))

data1=(np.loadtxt(f'/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Case10_Nov13/OVER_PLOT_CONTOURS/NB04_c10_lc_data.csv',delimiter=',',dtype='str')).transpose() 
