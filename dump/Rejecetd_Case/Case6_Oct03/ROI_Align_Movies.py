...
fol_nm='/Analysis/Projects_Data/Flare_Data/Oct03_Flare_Data1/Processed/'
...
search_fold='/Analysis/Projects_Data/Flare_Data/Oct03_Flare_Data1/' #'/scratch/suit_data/level1fits/2024/'+str(now.month).zfill(2)+'/'+str(now.day).zfill(2)+'/'+'normal_2k'+'/'
fdir =search_fold 
for fltr in Filters:
    if fltr=='NB03':
