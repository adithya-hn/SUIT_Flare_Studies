...
data1=(np.loadtxt(f'NB03_c1_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
Solexs=(np.loadtxt(f'AL1_SOLEXS_20240601_SDD2_L1_puc_tb_fit_results_TEMP_EM.txt',delimiter=' ',dtype='str')).transpose() #'NB08_Light_curve_data.dat'
