...
data=(np.loadtxt(f'mgIIk_h.csv',delimiter=',',skiprows=1,dtype='str')).transpose() #'NB03_Light_curve_data.dat'
#print(data[0])
...
plt.plot(time_array,float_array,'ko-',markersize=2,linewidth=0.5,label='Mg II h flux  ')
