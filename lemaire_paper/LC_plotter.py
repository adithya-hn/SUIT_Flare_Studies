...
data=(np.loadtxt(f'mgIIk_caIIk.csv',delimiter=',',skiprows=1,dtype='str')).transpose() #'NB03_Light_curve_data.dat'
#print(data[0])
...
plt.plot(time_array,float_array,'ko-',markersize=2,linewidth=0.5,label='Mg II k flux  ')

#axs.plot(time_array,float_array_er/float_array,'k-',markersize=0.1,linewidth=0.5,label='Total count of peak time contour')
...
m_cls_p=datetime.fromisoformat('1978-05-15T08:13:09.000')
#m_cls=datetime.fromisoformat('2024-06-01T08:29:00.000')


Flt=param
axis_title='Flux (10${^3}$ ergs/cm${^2}$/sr)' 
...
plt.axvline(m_cls_p,color='b',linestyle='-',label='Lyman-alpha peak time',alpha=0.5)
