...
data1=(np.loadtxt(f'NB03_c12_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
data2=(np.loadtxt(f'NB08_c12_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB08_Light_curve_data.dat'
...
m_cls=datetime.fromisoformat('2024-11-08T02:59:00.000')
m_cls_p=datetime.fromisoformat('2024-11-08T03:01:00.000')
