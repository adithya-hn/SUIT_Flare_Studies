...
fdir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Flare_stat/case20/data/processed/Aligned_images/'
cTx1=350
cTy1=350
cTx2=450
cTy2=460
...
for fltr in Filters:
    ...
    np.savetxt(f'{fltr}_c20_lc_data.csv',np.c_[date_array,fltr_count,fltr_count_err,bx_area],delimiter=',',fmt='%s')
