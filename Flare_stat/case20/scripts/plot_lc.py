...
data1=(np.loadtxt(f'NB03_c20_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
data2=(np.loadtxt(f'NB08_c20_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB08_Light_curve_data.dat'
data3=(np.loadtxt(f'NB04_c20_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB04_Light_curve_data.dat'

m_cls=datetime.fromisoformat('2024-12-31 22:46:00')
m_cls_p=datetime.fromisoformat('2024-12-31 22:50:00')
...
axs.errorbar(time_array3,list(map(int,float_array3)),yerr=float_array_er3_,fmt='ko-',capsize=2,markersize=2,linewidth=0.5, label='Mg II h light curve')
