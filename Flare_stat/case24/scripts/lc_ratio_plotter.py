...
data=(np.loadtxt(f'NB08_c22_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB08_Light_curve_data.dat'
NB3_data=(np.loadtxt(f'NB03_c22_lc_data.csv',delimiter=',',dtype='str')).transpose()
