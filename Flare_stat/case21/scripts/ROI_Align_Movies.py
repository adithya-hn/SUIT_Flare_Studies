...
fol_nm='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Flare_stat/case21/data/processed/'
...
search_fold='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Flare_stat/case21/data/raw/' 
ref_img_=sunpy.map.Map('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Flare_stat/case21/data/raw/SUT_T24_1592_000642_Lev1.0_2024-11-05T14.24.59.518_0983NB03.fits')
...
coords = SkyCoord(Tx=(ll.Tx.value+60,tr.Tx.value-60) * u.arcsec, Ty=(ll.Ty.value+60,tr.Ty.value-60) * u.arcsec, frame=scaled_map.coordinate_frame)
