...
data1=(np.loadtxt(f'NB03_c21_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
data2=(np.loadtxt(f'NB08_c21_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB08_Light_curve_data.dat'
data3=(np.loadtxt(f'NB04_c21_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB04_Light_curve_data.dat'

m_cls=datetime.fromisoformat('2024-11-05 13:58:00')
m_cls_p=datetime.fromisoformat('2024-11-05 14:19:00')
