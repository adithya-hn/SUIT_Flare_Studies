...
fdir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Flare_stat/case28/data/raw/'
cTx1=-361
cTy1=-204
cTx2=-254
cTy2=-102
...
for fltr in Filters:
    ...
    np.savetxt(f'{fltr}_c28_lc_data.csv',np.c_[date_array,fltr_count,fltr_count_err,bx_area],delimiter=',',fmt='%s')
