...
data1=(np.loadtxt(f'NB03_c13_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB03_Light_curve_data.dat'
data2=(np.loadtxt(f'NB08_c13_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB08_Light_curve_data.dat'
data3=(np.loadtxt(f'NB04_c13_lc_data.csv',delimiter=',',dtype='str')).transpose() #'NB04_Light_curve_data.dat'

m_cls=datetime.fromisoformat('2024-11-10T20:09:00.000')
m_cls_p=datetime.fromisoformat('2024-11-10T20:21:00.000')
