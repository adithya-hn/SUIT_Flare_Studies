...
flare_files = '/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Flare_stat/case13/data/raw/'
...
ref_mg_map = sunpy.map.Map('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Flare_stat/case13/data/raw/SUT_T24_1592_000649_Lev1.0_2024-11-10T20.17.38.674_0983NB03.fits')
...
ax.plot_coord(hpc_coord[0], color='red', linewidth=1,label='Flare contour')
plt.show()
'''
