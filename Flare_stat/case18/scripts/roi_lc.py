...
fdir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Flare_stat/case18/data/processed/Aligned_images/'
cTx1=400
cTy1=-290
cTx2=560
cTy2=-202
...
for fltr in Filters:
    ...
    np.savetxt(f'{fltr}_c18_lc_data.csv',np.c_[date_array,fltr_count,fltr_count_err,bx_area],delimiter=',',fmt='%s')
