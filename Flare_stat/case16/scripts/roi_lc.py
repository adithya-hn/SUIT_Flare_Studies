...
fdir='/Analysis/Research_Projects/Flare_studies/SUIT_Flares/Flare_stat/case16/data/processed/Aligned_images/'
cTx1=-470
cTy1=-390
cTx2=-390
cTy2=-315
...
for fltr in Filters:
    ...
    np.savetxt(f'{fltr}_c16_lc_data.csv',np.c_[date_array,fltr_count,fltr_count_err,bx_area],delimiter=',',fmt='%s')
