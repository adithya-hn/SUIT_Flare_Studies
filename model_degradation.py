...
data1=np.loadtxt('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/qual_data_NB04_bk1.csv',delimiter=',',dtype='str',skiprows=1)
data2=np.loadtxt('/Analysis/Research_Projects/Flare_studies/SUIT_Flares/qual_data_NB04_bk2.csv',delimiter=',',dtype='str',skiprows=1)
