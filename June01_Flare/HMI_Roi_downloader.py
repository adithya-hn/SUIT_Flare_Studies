...
end_time=Time('2024-06-01T7:07:00', scale='utc', format='isot')
...
query = Fido.search(a.Time(star_time,end_time),series,a.jsoc.Notify("adithya1@atulbhats.com"),cutout,) #a.
print(query)
