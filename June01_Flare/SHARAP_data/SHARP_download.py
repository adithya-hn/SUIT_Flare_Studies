...
save_dir = '/home/adithya/Research_Projects/Flare_studies/SUIT_Flares/June01_Flare/SHARAP_data/'
email_id = 'adithyabhattsringeri@gmail.com'

data = (pd.read_csv('/home/adithya/Research_Projects/Flare_studies/SUIT_Flares/June01_Flare/SHARAP_data/Suit_flare_Sharp_downloadList.csv', sep=',')).transpose()
Data=data.values
Ts=Data[2]
novaa_num=Data[1]
Harp_num=Data[0]
    ...
    if harp:
        ...
        if len(os.listdir(ts_dir)) < 9 :    
            ...
            for parameters in tqdm(pars):
                query_string = 'hmi.sharp_cea_720s_'+'['+str(harp)+']'+'['+qry_date+']' +parameters
                #print(query_string)
