...
def analyze_image_difference(dat_file, Filter='NB08', d=2):
    ...
    jpg_fold = os.path.join(fol_nm, 'FD_imgs', Filter)
    ...
    for i in range(len(files) - d):
        ...
        Diff_Map.plot(cmap=filterColor[Filter], vmin=0, vmax=0.7)
...
# Example usage
analyze_image_difference('/path/to/fits_file_list.dat', Filter='NB08', d=2)
